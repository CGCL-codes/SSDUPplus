...
DESTDIR =
srcdir = .
builddir = /home/summerkk/ICS/TACO/SSDUP_TACO
prefix = /home/summerkk/ICS/TACO/ssdup_install
...
LINUX_KERNEL_SRC = /usr/src/kernels/2.6.32-220.el6.x86_64/
LINUX24_KERNEL_SRC = 
...
CFLAGS = -I$(srcdir)/include  -g -O2  -I/usr/include
LDFLAGS = -L/home/summerkk/ICS/TACO/SSDUP_TACO/lib
LDFLAGS +=  -L/usr/lib64 -L/usr/lib -rdynamic
SERVER_LDFLAGS = -L/home/summerkk/ICS/TACO/SSDUP_TACO/lib
SERVER_LDFLAGS +=  -L/usr/lib64 -L/usr/lib -rdynamic -L/usr/lib64 -L/usr/lib 
DB_CFLAGS = 
LDSHARED = $(CC) -shared -L/home/summerkk/ICS/TACO/SSDUP_TACO/lib
PICFLAGS = -fPIC
...
CFLAGS += -DPVFS2_VERSION="\"2.9.3-orangefs\""
...
lib/liborangefs.so: $(OLIBPICOBJS) lib/libpvfs2.so
	$(Q) "  LDSO		$@"
	$(E)$(INSTALL) -d lib
	$(E)$(LDSHARED) -Wl,-soname,liborangefs.so,-z,interpose,-Bsymbolic -o $@ $(OLIBPICOBJS) $(OLIBDEPLIBS) $(DEPLIBS)
...
cscope:
	find /home/summerkk/ICS/TACO/SSDUP_TACO -iname "*.[ch]" -o -iname "*.sm" \
		 > $(srcdir)/cscope.files
	( cd /home/summerkk/ICS/TACO/SSDUP_TACO; cscope -be -i /home/summerkk/ICS/TACO/SSDUP_TACO/cscope.files )
...
clean:: 
	...
	$(E)rm -f $(LIBOBJS) $(LIBTHREADEDOBJS) \
                ...
                $(ULIBOBJS) $(OLIBOBJS) $(OLIBDEPENDS) \
                $(ULIBPICOBJS) $(ULIBDEPENDS) $(OLIBPICOBJS) \
...
dist: $(SMCGEN) cleaner
	@sh $(srcdir)/maint/make-dist.sh $(srcdir) 2.9.3-orangefs

ifdef BUILD_BMI_ONLY
# builds a tarball of the BMI source tree suitable for distribution
bmidist: cleaner
	@sh $(srcdir)/maint/make-bmi-dist.sh $(srcdir) $(builddir) 2.9.3-orangefs
...
cleaner: clean
	...
	rm -f pvfs-2.9.3-orangefs.tar.gz
