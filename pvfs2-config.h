...
#define AIO_PUT_REQ_RETURNS_INT 1

/* Define if struct backing_dev_info is defined */
#define BACKING_DEV_IN_ADDR_SPACE 1
...
/* #undef HAVE_CONST_SECURITY_CONTEXT */
...
#define HAVE_KIOCBSETCANCELLED 1
...
#define HAVE_READDIR_FILE_OPERATIONS 1
