...
static struct PINT_state_s ST_rmdirent_get_capability;
static struct PINT_pjmp_tbl_s ST_rmdirent_get_capability_pjtbl[];
static struct PINT_tran_tbl_s ST_rmdirent_get_capability_trtbl[];

static PINT_sm_action remove_rmdirent_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rmdirent_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_rmdirent_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_rmdirent_setup_msgpair_trtbl[];
static struct PINT_state_s ST_rmdirent_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_rmdirent_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_rmdirent_xfer_msgpair_trtbl[];

static PINT_sm_action remove_rmdirent_retry_or_fail(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rmdirent_retry_or_fail;
static struct PINT_pjmp_tbl_s ST_rmdirent_retry_or_fail_pjtbl[];
static struct PINT_tran_tbl_s ST_rmdirent_retry_or_fail_trtbl[];
...
static struct PINT_state_s ST_do_remove;
static struct PINT_pjmp_tbl_s ST_do_remove_pjtbl[];
static struct PINT_tran_tbl_s ST_do_remove_trtbl[];

static PINT_sm_action remove_check_error_code(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_check_error_code;
static struct PINT_pjmp_tbl_s ST_check_error_code_pjtbl[];
static struct PINT_tran_tbl_s ST_check_error_code_trtbl[];

static PINT_sm_action remove_generic_timer(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_crdirent_timer;
static struct PINT_pjmp_tbl_s ST_crdirent_timer_pjtbl[];
static struct PINT_tran_tbl_s ST_crdirent_timer_trtbl[];
static struct PINT_state_s ST_rmdirent_timer;
static struct PINT_pjmp_tbl_s ST_rmdirent_timer_pjtbl[];
static struct PINT_tran_tbl_s ST_rmdirent_timer_trtbl[];
...
static struct PINT_state_s ST_crdirent_retry_or_fail;
static struct PINT_pjmp_tbl_s ST_crdirent_retry_or_fail_pjtbl[];
static struct PINT_tran_tbl_s ST_crdirent_retry_or_fail_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_remove_sm = {
	.name = "pvfs2_client_remove_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_RUN ,
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_rmdirent_get_capability }
};

static struct PINT_state_s ST_rmdirent_get_capability = {
	 .state_name = "rmdirent_get_capability" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rmdirent_get_capability_trtbl 
};

static struct PINT_tran_tbl_s ST_rmdirent_get_capability_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rmdirent_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_rmdirent_retry_or_fail }
};

static struct PINT_state_s ST_rmdirent_setup_msgpair = {
	 .state_name = "rmdirent_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_rmdirent_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rmdirent_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_rmdirent_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rmdirent_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_rmdirent_retry_or_fail }
};

static struct PINT_state_s ST_rmdirent_xfer_msgpair = {
	 .state_name = "rmdirent_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rmdirent_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_rmdirent_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_do_remove },
	{ .return_value = -1 ,
	 .next_state = &ST_rmdirent_retry_or_fail }
};

static struct PINT_state_s ST_rmdirent_retry_or_fail = {
	 .state_name = "rmdirent_retry_or_fail" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_rmdirent_retry_or_fail ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rmdirent_retry_or_fail_trtbl 
};

static struct PINT_tran_tbl_s ST_rmdirent_retry_or_fail_trtbl[] = {
	{ .return_value = RMDIRENT_RETRY ,
	 .next_state = &ST_rmdirent_timer },
	{ .return_value = RMDIRENT_RETRY_NEED_GETATTR ,
...
static struct PINT_state_s ST_do_remove = {
	 .state_name = "do_remove" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_remove_helper_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_do_remove_trtbl 
};

static struct PINT_tran_tbl_s ST_do_remove_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_check_error_code }
};

static struct PINT_state_s ST_check_error_code = {
	 .state_name = "check_error_code" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_check_error_code ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_error_code_trtbl 
};

static struct PINT_tran_tbl_s ST_check_error_code_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_cleanup },
	{ .return_value = RETURN_STORED_ERROR_CODE ,
	 .next_state = &ST_cleanup },
	{ .return_value = -1 ,
...
static struct PINT_state_s ST_crdirent_timer = {
	 .state_name = "crdirent_timer" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_generic_timer ,
	 .pjtbl = NULL ,
	 .trtbl = ST_crdirent_timer_trtbl 
};
...
static struct PINT_state_s ST_rmdirent_timer = {
	 .state_name = "rmdirent_timer" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_generic_timer ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rmdirent_timer_trtbl 
};
...
static struct PINT_state_s ST_crdirent_setup_msgpair = {
	 ...
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_crdirent_setup_msgpair ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_crdirent_setup_msgpair_trtbl[] = {
	...
	{ .return_value = -1 ,
	 .next_state = &ST_crdirent_retry_or_fail }
};
...
static struct PINT_state_s ST_crdirent_retry_or_fail = {
	 .state_name = "crdirent_retry_or_fail" ,
	 .parent_machine = &pvfs2_client_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_crdirent_retry_or_fail ,
	 .pjtbl = NULL ,
	 .trtbl = ST_crdirent_retry_or_fail_trtbl 
};

static struct PINT_tran_tbl_s ST_crdirent_retry_or_fail_trtbl[] = {
	{ .return_value = CRDIRENT_RETRY ,
	 .next_state = &ST_crdirent_timer },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};
...
#ifndef WIN32
# 177 "src/client/sysint/sys-remove.sm"
#endif
