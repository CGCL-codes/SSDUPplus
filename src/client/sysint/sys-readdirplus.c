...
static struct PINT_state_s ST_readdirplus_fetch_attrs_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_readdirplus_fetch_attrs_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_readdirplus_fetch_attrs_setup_msgpair_trtbl[];
static struct PINT_state_s ST_readdirplus_fetch_attrs_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_readdirplus_fetch_attrs_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_readdirplus_fetch_attrs_xfer_msgpair_trtbl[];

static PINT_sm_action readdirplus_fetch_sizes_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_readdirplus_fetch_sizes_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_readdirplus_fetch_sizes_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_readdirplus_fetch_sizes_setup_msgpair_trtbl[];
static struct PINT_state_s ST_readdirplus_fetch_sizes_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_readdirplus_fetch_sizes_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_readdirplus_fetch_sizes_xfer_msgpair_trtbl[];

static PINT_sm_action readdirplus_msg_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_readdirplus_msg_failure;
static struct PINT_pjmp_tbl_s ST_readdirplus_msg_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_readdirplus_msg_failure_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_readdirplus_sm = {
	.name = "pvfs2_client_readdirplus_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_readdirplus_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_readdirplus_fetch_attrs_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_readdirplus_msg_failure }
};

static struct PINT_state_s ST_readdirplus_fetch_attrs_setup_msgpair = {
	 .state_name = "readdirplus_fetch_attrs_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_readdirplus_sm ,
	 .flag = SM_RUN ,
	 .action.func = readdirplus_fetch_attrs_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_readdirplus_fetch_attrs_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_readdirplus_fetch_attrs_setup_msgpair_trtbl[] = {
	{ .return_value = NO_WORK ,
	 .next_state = &ST_cleanup },
	{ .return_value = 0 ,
	 .next_state = &ST_readdirplus_fetch_attrs_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_readdirplus_msg_failure }
};

static struct PINT_state_s ST_readdirplus_fetch_attrs_xfer_msgpair = {
	 .state_name = "readdirplus_fetch_attrs_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_readdirplus_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_readdirplus_fetch_attrs_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_readdirplus_fetch_attrs_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_readdirplus_fetch_sizes_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_readdirplus_msg_failure }
};

static struct PINT_state_s ST_readdirplus_fetch_sizes_setup_msgpair = {
	 .state_name = "readdirplus_fetch_sizes_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_readdirplus_sm ,
	 .flag = SM_RUN ,
	 .action.func = readdirplus_fetch_sizes_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_readdirplus_fetch_sizes_setup_msgpair_trtbl 
};
...
static struct PINT_tran_tbl_s ST_readdirplus_fetch_sizes_setup_msgpair_trtbl[] = {
	{ .return_value = NO_WORK ,
	 .next_state = &ST_cleanup },
	{ .return_value = 0 ,
	 .next_state = &ST_readdirplus_fetch_sizes_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_readdirplus_msg_failure }
};

static struct PINT_state_s ST_readdirplus_fetch_sizes_xfer_msgpair = {
	 .state_name = "readdirplus_fetch_sizes_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_readdirplus_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_readdirplus_fetch_sizes_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_readdirplus_msg_failure = {
	 .state_name = "readdirplus_msg_failure" ,
	 .parent_machine = &pvfs2_client_readdirplus_sm ,
	 .flag = SM_RUN ,
	 .action.func = readdirplus_msg_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_readdirplus_msg_failure_trtbl 
};
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_client_readdirplus_sm ,
	 .flag = SM_RUN ,
	 .action.func = readdirplus_cleanup ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 99 "src/client/sysint/sys-readdirplus.sm"
#endif
    ...
    PVFS_hint hints)
{
    ...
    ret = PVFS_isys_readdirplus(ref, token, pvfs_dirent_incount,
                            credential, attrmask, resp, &op_id, NULL, hints);
    if (ret)
    {
    ...
    struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    if (readdirplus_resp != NULL && readdirplus_resp->dirent_array != NULL &&
        readdirplus_resp->stat_err_array != NULL && 
        readdirplus_resp->attr_array != NULL)
    {
        /* Walk through the object attributes and convert them into system 
           attributes for those without errors */
        for (i = 0; i < readdirplus_resp->pvfs_dirent_outcount; i++) 
        {
            if (readdirplus_resp->stat_err_array[i] == 0)
            {
                ...
                if (readdirplus_resp->attr_array[i].objtype == 
                    PVFS_TYPE_METAFILE)
                {
                    if (sm_p->u.readdirplus.attrmask & PVFS_ATTR_META_DIST)
                    {
                            ...
                            PVFS_ATTR_META_UNSTUFFED)
                        {
                             ...
                             logical_file_size = 
                                sm_p->u.readdirplus.obj_attr_array[i].
                                 u.meta.dist->methods->logical_file_size;
                             assert(logical_file_size);
                             assert(sm_p->u.readdirplus.obj_attr_array[i].
                                    u.meta.dist->params);
    
                             readdirplus_resp->attr_array[i].size = 
                                 logical_file_size(sm_p->u.readdirplus.
                                                    obj_attr_array[i].u.
                                                     meta.dist->params,
                                                   sm_p->u.readdirplus.
                                                    obj_attr_array[i].u.
                        ...
                        else
                        {
                           ...
                           readdirplus_resp->attr_array[i].size = 
                               sm_p->u.readdirplus.obj_attr_array[i].u.
                                meta.stuffed_size;
                        }
                        readdirplus_resp->attr_array[i].mask |= 
                            PVFS_ATTR_SYS_SIZE;
                         ...
                         PVFS_TYPE_DIRECTORY)
                {
                    ...
                    readdirplus_resp->attr_array[i].mask |=
                        PVFS_ATTR_SYS_DIRENT_COUNT;
                         ...
                         PVFS_TYPE_SYMLINK && sm_p->u.readdirplus.attrmask & 
                         PVFS_ATTR_SYMLNK_TARGET) 
                {
                    readdirplus_resp->attr_array[i].link_target =
                        strdup(sm_p->u.readdirplus.obj_attr_array[i].u.
                                sym.target_path);
                    readdirplus_resp->attr_array[i].mask |= 
