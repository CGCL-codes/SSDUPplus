...
static struct PINT_state_s ST_truncate_getattr;
static struct PINT_pjmp_tbl_s ST_truncate_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_truncate_getattr_trtbl[];
...
static struct PINT_state_s ST_truncate_datafile_setup_msgpairarray;
static struct PINT_pjmp_tbl_s ST_truncate_datafile_setup_msgpairarray_pjtbl[];
static struct PINT_tran_tbl_s ST_truncate_datafile_setup_msgpairarray_trtbl[];
static struct PINT_state_s ST_truncate_datafile_xfer_msgpairarray;
static struct PINT_pjmp_tbl_s ST_truncate_datafile_xfer_msgpairarray_pjtbl[];
static struct PINT_tran_tbl_s ST_truncate_datafile_xfer_msgpairarray_trtbl[];

static PINT_sm_action truncate_datafile_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_truncate_datafile_failure;
static struct PINT_pjmp_tbl_s ST_truncate_datafile_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_truncate_datafile_failure_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_truncate_sm = {
	...
	.first_state = &ST_truncate_getattr
};
...
static struct PINT_state_s ST_truncate_getattr = {
	 ...
	 .pjtbl = NULL ,
	 .trtbl = ST_truncate_getattr_trtbl 
};
...
static struct PINT_state_s ST_inspect_attr = {
	 ...
	 .parent_machine = &pvfs2_client_truncate_sm ,
	 .flag = SM_RUN ,
	 .action.func = truncate_inspect_attr ,
	 .pjtbl = NULL ,
	 .trtbl = ST_inspect_attr_trtbl 
};

static struct PINT_tran_tbl_s ST_inspect_attr_trtbl[] = {
	{ .return_value = TRUNCATE_UNSTUFF ,
...
static struct PINT_state_s ST_unstuff_setup_msgpair = {
	 ...
	 .parent_machine = &pvfs2_client_truncate_sm ,
	 .flag = SM_RUN ,
	 .action.func = truncate_unstuff_setup_msgpair ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_truncate_datafile_setup_msgpairarray = {
	 ...
	 .parent_machine = &pvfs2_client_truncate_sm ,
	 .flag = SM_RUN ,
	 .action.func = truncate_datafile_setup_msgpairarray ,
	 .pjtbl = NULL ,
	 .trtbl = ST_truncate_datafile_setup_msgpairarray_trtbl 
};
...
static struct PINT_state_s ST_truncate_datafile_xfer_msgpairarray = {
	 ...
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_truncate_datafile_xfer_msgpairarray_trtbl 
};
...
static struct PINT_state_s ST_truncate_datafile_failure = {
	 ...
	 .parent_machine = &pvfs2_client_truncate_sm ,
	 .flag = SM_RUN ,
	 .action.func = truncate_datafile_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_truncate_datafile_failure_trtbl 
};
...
#ifndef WIN32
# 101 "src/client/sysint/sys-truncate.sm"
#endif
    ...
    struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    assert(attr);
    //printf("attr->mask = %llu, PVFS_ATTR_CAPABILITY = %llu", attr->mask, PVFS_ATTR_CAPABILITY);
