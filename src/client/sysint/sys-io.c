...
static struct PINT_state_s ST_io_atime_setattr_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_io_atime_setattr_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_io_atime_setattr_xfer_msgpair_trtbl[];

static PINT_sm_action io_unstuff_needed_check(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_unstuff_needed_check;
static struct PINT_pjmp_tbl_s ST_unstuff_needed_check_pjtbl[];
static struct PINT_tran_tbl_s ST_unstuff_needed_check_trtbl[];
...
static PINT_sm_action io_datafile_no_mirror_retry(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_io_datafile_no_mirror_retry;
static struct PINT_pjmp_tbl_s ST_io_datafile_no_mirror_retry_pjtbl[];
static struct PINT_tran_tbl_s ST_io_datafile_no_mirror_retry_trtbl[];

static PINT_sm_action io_datafile_mirror_retry(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_io_datafile_mirror_retry;
static struct PINT_pjmp_tbl_s ST_io_datafile_mirror_retry_pjtbl[];
static struct PINT_tran_tbl_s ST_io_datafile_mirror_retry_trtbl[];
...
static struct PINT_state_s ST_io_renew_capability;
static struct PINT_pjmp_tbl_s ST_io_renew_capability_pjtbl[];
static struct PINT_tran_tbl_s ST_io_renew_capability_trtbl[];
static struct PINT_state_s ST_io_renew_getattr;
static struct PINT_pjmp_tbl_s ST_io_renew_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_io_renew_getattr_trtbl[];
...
static struct PINT_tran_tbl_s ST_inspect_attr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_unstuff_needed_check },
	{ .return_value = IO_ATIME_UPDATE ,
	 .next_state = &ST_io_atime_setattr_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_io_cleanup }
};

static struct PINT_state_s ST_io_atime_setattr_xfer_msgpair = {
	 .state_name = "io_atime_setattr_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_atime_setattr_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_unstuff_needed_check = {
	 .state_name = "unstuff_needed_check" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_unstuff_needed_check ,
	 .pjtbl = NULL ,
	 .trtbl = ST_unstuff_needed_check_trtbl 
};
...
static struct PINT_tran_tbl_s ST_io_datafile_post_msgpairs_retry_trtbl[] = {
	{ .return_value = IO_MIRRORING ,
	 .next_state = &ST_io_datafile_mirror_retry },
	{ .return_value = IO_NO_MIRRORING ,
	 .next_state = &ST_io_datafile_no_mirror_retry },
	{ .return_value = -1 ,
	 .next_state = &ST_io_datafile_no_mirror_retry }
};

static struct PINT_state_s ST_io_datafile_no_mirror_retry = {
	 .state_name = "io_datafile_no_mirror_retry" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_datafile_no_mirror_retry ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_datafile_no_mirror_retry_trtbl 
};
...
static struct PINT_state_s ST_io_datafile_mirror_retry = {
	 .state_name = "io_datafile_mirror_retry" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_datafile_mirror_retry ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_datafile_mirror_retry_trtbl 
};
...
static struct PINT_tran_tbl_s ST_io_datafile_complete_operations_trtbl[] = {
	...
	{ .return_value = IO_RETRY ,
	 .next_state = &ST_io_datafile_post_msgpairs_retry },
	{ .return_value = IO_RENEW_CAPABILITY ,
	 .next_state = &ST_io_renew_capability },
	{ .return_value = -1 ,
	 .next_state = &ST_io_datafile_complete_operations }
};

static struct PINT_state_s ST_io_renew_capability = {
	 .state_name = "io_renew_capability" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_renew_capability_trtbl 
};

static struct PINT_tran_tbl_s ST_io_renew_capability_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_io_renew_getattr }
};

static struct PINT_state_s ST_io_renew_getattr = {
	 .state_name = "io_renew_getattr" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_renew_getattr_trtbl 
};
...
#ifndef WIN32
# 309 "src/client/sysint/sys-io.sm"
#endif
