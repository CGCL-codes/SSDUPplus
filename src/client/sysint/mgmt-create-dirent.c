...
static struct PINT_state_s ST_create_dirent_get_capability;
static struct PINT_pjmp_tbl_s ST_create_dirent_get_capability_pjtbl[];
static struct PINT_tran_tbl_s ST_create_dirent_get_capability_trtbl[];

static PINT_sm_action mgmt_create_dirent_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_create_dirent_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_create_dirent_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_create_dirent_setup_msgpair_trtbl[];
static struct PINT_state_s ST_create_dirent_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_create_dirent_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_create_dirent_xfer_msgpair_trtbl[];

static PINT_sm_action mgmt_create_dirent_retry_or_fail(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_create_dirent_retry_or_fail;
static struct PINT_pjmp_tbl_s ST_create_dirent_retry_or_fail_pjtbl[];
static struct PINT_tran_tbl_s ST_create_dirent_retry_or_fail_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_mgmt_create_dirent_sm = {
	.name = "pvfs2_client_mgmt_create_dirent_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_mgmt_create_dirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_dirent_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_create_dirent_get_capability }
};

static struct PINT_state_s ST_create_dirent_get_capability = {
	 .state_name = "create_dirent_get_capability" ,
	 .parent_machine = &pvfs2_client_mgmt_create_dirent_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_dirent_get_capability_trtbl 
};

static struct PINT_tran_tbl_s ST_create_dirent_get_capability_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_create_dirent_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_create_dirent_setup_msgpair = {
	 .state_name = "create_dirent_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_mgmt_create_dirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_dirent_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_dirent_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_create_dirent_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_create_dirent_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_create_dirent_xfer_msgpair = {
	 .state_name = "create_dirent_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_mgmt_create_dirent_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_dirent_xfer_msgpair_trtbl 
};
...
static struct PINT_tran_tbl_s ST_create_dirent_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_cleanup },
	{ .return_value = -1 ,
	 .next_state = &ST_create_dirent_retry_or_fail }
};

static struct PINT_state_s ST_create_dirent_retry_or_fail = {
	 .state_name = "create_dirent_retry_or_fail" ,
	 .parent_machine = &pvfs2_client_mgmt_create_dirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_dirent_retry_or_fail ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_dirent_retry_or_fail_trtbl 
};
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_client_mgmt_create_dirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_dirent_cleanup ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 77 "src/client/sysint/mgmt-create-dirent.sm"
#endif
