...
struct PINT_state_machine_s pvfs2_client_mgmt_event_mon_list_sm = {
	.name = "pvfs2_client_mgmt_event_mon_list_sm",
	.first_state = &ST_setup_msgpair
};

static struct PINT_state_s ST_setup_msgpair = {
	 .state_name = "setup_msgpair" ,
	 .parent_machine = &pvfs2_client_mgmt_event_mon_list_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_event_mon_list_setup_msgpair ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_client_mgmt_event_mon_list_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_event_mon_list_cleanup ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 55 "src/client/sysint/mgmt-event-mon-list.sm"
#endif
