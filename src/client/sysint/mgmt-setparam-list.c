...
static PINT_sm_action mgmt_setparam_list_init(
...
static struct PINT_state_s ST_setparam_list_get_capability;
static struct PINT_pjmp_tbl_s ST_setparam_list_get_capability_pjtbl[];
static struct PINT_tran_tbl_s ST_setparam_list_get_capability_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_mgmt_setparam_list_sm = {
	.name = "pvfs2_client_mgmt_setparam_list_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_mgmt_setparam_list_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_setparam_list_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_setparam_list_get_capability }
};

static struct PINT_state_s ST_setparam_list_get_capability = {
	 .state_name = "setparam_list_get_capability" ,
	 .parent_machine = &pvfs2_client_mgmt_setparam_list_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_setparam_list_get_capability_trtbl 
};
...
static struct PINT_state_s ST_setup_msgpair = {
	 ...
	 .parent_machine = &pvfs2_client_mgmt_setparam_list_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_setparam_list_setup_msgpair ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_client_mgmt_setparam_list_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_setparam_list_cleanup ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 71 "src/client/sysint/mgmt-setparam-list.sm"
#endif
...
static int mgmt_setparam_list_init(
    struct PINT_smcb *smcb, job_status_s *js_p)
{    
