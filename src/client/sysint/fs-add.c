...
static PINT_sm_action fs_add_parent_cleanup(
...
static struct PINT_state_s ST_config_integrity_checks;
static struct PINT_pjmp_tbl_s ST_config_integrity_checks_pjtbl[];
static struct PINT_tran_tbl_s ST_config_integrity_checks_trtbl[];
static struct PINT_state_s ST_do_config_integrity_checks;
static struct PINT_pjmp_tbl_s ST_do_config_integrity_checks_pjtbl[];
static struct PINT_tran_tbl_s ST_do_config_integrity_checks_trtbl[];

static PINT_sm_action fs_add_compare_hashes(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_compare_hashes;
static struct PINT_pjmp_tbl_s ST_compare_hashes_pjtbl[];
static struct PINT_tran_tbl_s ST_compare_hashes_trtbl[];

static PINT_sm_action fs_add_final_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_final_cleanup;
static struct PINT_pjmp_tbl_s ST_final_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_final_cleanup_trtbl[];
...
static struct PINT_state_s ST_parent_cleanup = {
	 ...
	 .parent_machine = &pvfs2_fs_add_sm ,
	 .flag = SM_RUN ,
	 .action.func = fs_add_parent_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_parent_cleanup_trtbl 
};

static struct PINT_tran_tbl_s ST_parent_cleanup_trtbl[] = {
	{ .return_value = SKIP_INTEGRITY_CHECK ,
	 .next_state = &ST_final_cleanup },
	{ .return_value = 0 ,
	 .next_state = &ST_config_integrity_checks },
	{ .return_value = -1 ,
	 .next_state = &ST_final_cleanup }
};

static struct PINT_state_s ST_config_integrity_checks = {
	 .state_name = "config_integrity_checks" ,
	 .parent_machine = &pvfs2_fs_add_sm ,
	 .flag = SM_RUN ,
	 .action.func = pvfs2_server_prepare_fetch_config ,
	 .pjtbl = NULL ,
	 .trtbl = ST_config_integrity_checks_trtbl 
};
...
static struct PINT_tran_tbl_s ST_config_integrity_checks_trtbl[] = {
	{ .return_value = SKIP_INTEGRITY_CHECK ,
	 .next_state = &ST_final_cleanup },
	{ .return_value = 0 ,
	 .next_state = &ST_do_config_integrity_checks },
	{ .return_value = -1 ,
	 .next_state = &ST_final_cleanup }
};

static struct PINT_state_s ST_do_config_integrity_checks = {
	 .state_name = "do_config_integrity_checks" ,
	 .parent_machine = &pvfs2_fs_add_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_server_fetch_config_nested_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_do_config_integrity_checks_trtbl 
};

static struct PINT_tran_tbl_s ST_do_config_integrity_checks_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_compare_hashes }
};

static struct PINT_state_s ST_compare_hashes = {
	 .state_name = "compare_hashes" ,
	 .parent_machine = &pvfs2_fs_add_sm ,
	 .flag = SM_RUN ,
	 .action.func = fs_add_compare_hashes ,
	 .pjtbl = NULL ,
	 .trtbl = ST_compare_hashes_trtbl 
};
...
static struct PINT_state_s ST_final_cleanup = {
	 .state_name = "final_cleanup" ,
	 .parent_machine = &pvfs2_fs_add_sm ,
	 .flag = SM_RUN ,
	 .action.func = fs_add_final_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_final_cleanup_trtbl 
};
...
static PINT_sm_action server_fetch_config_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_fetch_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_fetch_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_fetch_setup_msgpair_trtbl[];
static struct PINT_state_s ST_fetch_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_fetch_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_fetch_xfer_msgpair_trtbl[];

static PINT_sm_action server_fetch_config_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_fetch_cleanup;
static struct PINT_pjmp_tbl_s ST_fetch_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_fetch_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_server_fetch_config_nested_sm = {
	.name = "pvfs2_server_fetch_config_nested_sm",
	.first_state = &ST_fetch_setup_msgpair
};

static struct PINT_state_s ST_fetch_setup_msgpair = {
	 .state_name = "fetch_setup_msgpair" ,
	 .parent_machine = &pvfs2_server_fetch_config_nested_sm ,
	 .flag = SM_RUN ,
	 .action.func = server_fetch_config_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_fetch_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_fetch_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_fetch_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_fetch_cleanup }
};

static struct PINT_state_s ST_fetch_xfer_msgpair = {
	 .state_name = "fetch_xfer_msgpair" ,
	 .parent_machine = &pvfs2_server_fetch_config_nested_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_fetch_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_fetch_cleanup = {
	 .state_name = "fetch_cleanup" ,
	 .parent_machine = &pvfs2_server_fetch_config_nested_sm ,
	 .flag = SM_RUN ,
	 .action.func = server_fetch_config_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_fetch_cleanup_trtbl 
};
...
#ifndef WIN32
# 119 "src/client/sysint/fs-add.sm"
#endif
    ...
    struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    ret = PVFS_mgmt_count_servers(
        fsid, PVFS_MGMT_IO_SERVER | PVFS_MGMT_META_SERVER, 
        &count);
    if (ret < 0)
    {
