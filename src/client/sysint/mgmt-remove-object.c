...
static struct PINT_state_s ST_remove_object_get_capability;
static struct PINT_pjmp_tbl_s ST_remove_object_get_capability_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_object_get_capability_trtbl[];

static PINT_sm_action mgmt_remove_object_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remove_object_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_remove_object_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_object_setup_msgpair_trtbl[];
static struct PINT_state_s ST_remove_object_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_remove_object_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_object_xfer_msgpair_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_mgmt_remove_object_sm = {
	.name = "pvfs2_client_mgmt_remove_object_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_mgmt_remove_object_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_remove_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_remove_object_get_capability }
};

static struct PINT_state_s ST_remove_object_get_capability = {
	 .state_name = "remove_object_get_capability" ,
	 .parent_machine = &pvfs2_client_mgmt_remove_object_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_object_get_capability_trtbl 
};

static struct PINT_tran_tbl_s ST_remove_object_get_capability_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_remove_object_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_remove_object_setup_msgpair = {
	 .state_name = "remove_object_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_mgmt_remove_object_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_remove_object_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_object_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_remove_object_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_remove_object_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_remove_object_xfer_msgpair = {
	 .state_name = "remove_object_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_mgmt_remove_object_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_object_xfer_msgpair_trtbl 
};
...
#ifndef WIN32
# 69 "src/client/sysint/mgmt-remove-object.sm"
#endif
    ...
    PVFS_hint hints)
{
    ...
    ret = PVFS_imgmt_remove_object(object_ref, credential, &op_id, NULL, hints);
    if (ret)
    {
