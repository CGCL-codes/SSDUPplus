...
static struct PINT_state_s ST_mkdir_msg_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_mkdir_msg_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_msg_setup_msgpair_trtbl[];
static struct PINT_state_s ST_mkdir_msg_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_mkdir_msg_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_msg_xfer_msgpair_trtbl[];

static PINT_sm_action mkdir_msg_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_mkdir_msg_failure;
static struct PINT_pjmp_tbl_s ST_mkdir_msg_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_msg_failure_trtbl[];

static PINT_sm_action mkdir_seteattr_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_mkdir_seteattr_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_mkdir_seteattr_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_seteattr_setup_msgpair_trtbl[];
static struct PINT_state_s ST_mkdir_seteattr_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_mkdir_seteattr_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_seteattr_xfer_msgpair_trtbl[];

static PINT_sm_action mkdir_seteattr_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_mkdir_seteattr_failure;
static struct PINT_pjmp_tbl_s ST_mkdir_seteattr_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_seteattr_failure_trtbl[];

static PINT_sm_action mkdir_crdirent_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_mkdir_crdirent_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_mkdir_crdirent_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_crdirent_setup_msgpair_trtbl[];
static struct PINT_state_s ST_mkdir_crdirent_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_mkdir_crdirent_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_crdirent_xfer_msgpair_trtbl[];

static PINT_sm_action mkdir_crdirent_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_mkdir_crdirent_failure;
static struct PINT_pjmp_tbl_s ST_mkdir_crdirent_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_crdirent_failure_trtbl[];
static struct PINT_state_s ST_mkdir_crdirent_retry_getattr;
static struct PINT_pjmp_tbl_s ST_mkdir_crdirent_retry_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_crdirent_retry_getattr_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_mkdir_sm = {
	.name = "pvfs2_client_mkdir_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_RUN ,
...
static struct PINT_state_s ST_parent_getattr_inspect = {
	 ...
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_parent_getattr_inspect ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_parent_getattr_inspect_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_mkdir_msg_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_mkdir_msg_setup_msgpair = {
	 .state_name = "mkdir_msg_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_msg_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_msg_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_mkdir_msg_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_mkdir_msg_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_mkdir_msg_failure }
};

static struct PINT_state_s ST_mkdir_msg_xfer_msgpair = {
	 .state_name = "mkdir_msg_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_msg_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_mkdir_msg_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_mkdir_seteattr_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_mkdir_msg_failure }
};

static struct PINT_state_s ST_mkdir_msg_failure = {
	 .state_name = "mkdir_msg_failure" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_msg_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_msg_failure_trtbl 
};
...
static struct PINT_state_s ST_mkdir_seteattr_setup_msgpair = {
	 .state_name = "mkdir_seteattr_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_seteattr_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_seteattr_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_mkdir_seteattr_setup_msgpair_trtbl[] = {
	{ .return_value = MKDIR_SKIP_EATTR ,
	 .next_state = &ST_mkdir_crdirent_setup_msgpair },
	{ .return_value = 0 ,
	 .next_state = &ST_mkdir_seteattr_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_mkdir_seteattr_failure }
};

static struct PINT_state_s ST_mkdir_seteattr_xfer_msgpair = {
	 .state_name = "mkdir_seteattr_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_seteattr_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_mkdir_seteattr_failure = {
	 .state_name = "mkdir_seteattr_failure" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_seteattr_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_seteattr_failure_trtbl 
};
...
static struct PINT_state_s ST_mkdir_crdirent_setup_msgpair = {
	 .state_name = "mkdir_crdirent_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_crdirent_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_crdirent_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_mkdir_crdirent_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_mkdir_crdirent_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_mkdir_crdirent_failure }
};

static struct PINT_state_s ST_mkdir_crdirent_xfer_msgpair = {
	 .state_name = "mkdir_crdirent_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_crdirent_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_mkdir_crdirent_failure = {
	 .state_name = "mkdir_crdirent_failure" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_crdirent_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_crdirent_failure_trtbl 
};

static struct PINT_tran_tbl_s ST_mkdir_crdirent_failure_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_mkdir_crdirent_retry_getattr },
	{ .return_value = -1 ,
	 .next_state = &ST_delete_handle_setup_msgpair }
};

static struct PINT_state_s ST_mkdir_crdirent_retry_getattr = {
	 .state_name = "mkdir_crdirent_retry_getattr" ,
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_crdirent_retry_getattr_trtbl 
};
...
static struct PINT_state_s ST_delete_handle_setup_msgpair = {
	 ...
	 .parent_machine = &pvfs2_client_mkdir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_delete_handle_setup_msgpair ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 162 "src/client/sysint/sys-mkdir.sm"
#endif
