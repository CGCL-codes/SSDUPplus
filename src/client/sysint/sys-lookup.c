...
static PINT_sm_action lookup_segment_start(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_segment_start;
static struct PINT_pjmp_tbl_s ST_lookup_segment_start_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_start_trtbl[];

static PINT_sm_action lookup_segment_query_ncache(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_segment_query_ncache;
static struct PINT_pjmp_tbl_s ST_lookup_segment_query_ncache_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_query_ncache_trtbl[];

static PINT_sm_action lookup_segment_setup_parent_getattr(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_segment_setup_parent_getattr;
static struct PINT_pjmp_tbl_s ST_lookup_segment_setup_parent_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_setup_parent_getattr_trtbl[];
static struct PINT_state_s ST_lookup_segment_parent_getattr;
static struct PINT_pjmp_tbl_s ST_lookup_segment_parent_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_parent_getattr_trtbl[];

static PINT_sm_action lookup_segment_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_segment_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_lookup_segment_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_setup_msgpair_trtbl[];
static struct PINT_state_s ST_lookup_segment_lookup_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_lookup_segment_lookup_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_lookup_xfer_msgpair_trtbl[];

static PINT_sm_action lookup_segment_lookup_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_segment_lookup_failure;
static struct PINT_pjmp_tbl_s ST_lookup_segment_lookup_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_lookup_failure_trtbl[];

static PINT_sm_action lookup_segment_verify_attr_present(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_segment_verify_attr_present;
static struct PINT_pjmp_tbl_s ST_lookup_segment_verify_attr_present_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_verify_attr_present_trtbl[];
static struct PINT_state_s ST_lookup_segment_getattr;
static struct PINT_pjmp_tbl_s ST_lookup_segment_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_getattr_trtbl[];

static PINT_sm_action lookup_segment_check_attr_type(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_segment_check_attr_type;
static struct PINT_pjmp_tbl_s ST_lookup_segment_check_attr_type_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_check_attr_type_trtbl[];

static PINT_sm_action lookup_context_check_completion(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_context_check_completion;
static struct PINT_pjmp_tbl_s ST_lookup_context_check_completion_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_context_check_completion_trtbl[];

static PINT_sm_action lookup_segment_handle_relative_link(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_segment_handle_relative_link;
static struct PINT_pjmp_tbl_s ST_lookup_segment_handle_relative_link_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_handle_relative_link_trtbl[];

static PINT_sm_action lookup_segment_handle_absolute_link(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_segment_handle_absolute_link;
static struct PINT_pjmp_tbl_s ST_lookup_segment_handle_absolute_link_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_segment_handle_absolute_link_trtbl[];

static PINT_sm_action lookup_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_lookup_cleanup;
static struct PINT_pjmp_tbl_s ST_lookup_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_lookup_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_client_lookup_sm = {
	.name = "pvfs2_client_lookup_sm",
	.first_state = &ST_lookup_segment_start
};

static struct PINT_state_s ST_lookup_segment_start = {
	 .state_name = "lookup_segment_start" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_segment_start ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_start_trtbl 
};

static struct PINT_tran_tbl_s ST_lookup_segment_start_trtbl[] = {
	{ .return_value = LOOKUP_CONTINUE ,
	 .next_state = &ST_lookup_context_check_completion },
	{ .return_value = 0 ,
	 .next_state = &ST_lookup_segment_query_ncache },
	{ .return_value = -1 ,
	 .next_state = &ST_lookup_segment_lookup_failure }
};

static struct PINT_state_s ST_lookup_segment_query_ncache = {
	 .state_name = "lookup_segment_query_ncache" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_segment_query_ncache ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_query_ncache_trtbl 
};

static struct PINT_tran_tbl_s ST_lookup_segment_query_ncache_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_lookup_segment_verify_attr_present },
	{ .return_value = -1 ,
	 .next_state = &ST_lookup_segment_setup_parent_getattr }
};

static struct PINT_state_s ST_lookup_segment_setup_parent_getattr = {
	 .state_name = "lookup_segment_setup_parent_getattr" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_segment_setup_parent_getattr ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_setup_parent_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_lookup_segment_setup_parent_getattr_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_lookup_segment_parent_getattr }
};

static struct PINT_state_s ST_lookup_segment_parent_getattr = {
	 .state_name = "lookup_segment_parent_getattr" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_parent_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_lookup_segment_parent_getattr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_lookup_segment_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_lookup_segment_lookup_failure }
};

static struct PINT_state_s ST_lookup_segment_setup_msgpair = {
	 .state_name = "lookup_segment_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_segment_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_lookup_segment_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_lookup_segment_lookup_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_lookup_segment_lookup_failure }
};

static struct PINT_state_s ST_lookup_segment_lookup_xfer_msgpair = {
	 .state_name = "lookup_segment_lookup_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_lookup_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_lookup_segment_lookup_failure = {
	 .state_name = "lookup_segment_lookup_failure" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_segment_lookup_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_lookup_failure_trtbl 
};

static struct PINT_tran_tbl_s ST_lookup_segment_lookup_failure_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_lookup_cleanup }
};

static struct PINT_state_s ST_lookup_segment_verify_attr_present = {
	 .state_name = "lookup_segment_verify_attr_present" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_segment_verify_attr_present ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_verify_attr_present_trtbl 
};

static struct PINT_tran_tbl_s ST_lookup_segment_verify_attr_present_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_lookup_segment_check_attr_type },
	{ .return_value = -1 ,
	 .next_state = &ST_lookup_segment_getattr }
};

static struct PINT_state_s ST_lookup_segment_getattr = {
	 .state_name = "lookup_segment_getattr" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_getattr_trtbl 
};
...
static struct PINT_state_s ST_lookup_segment_check_attr_type = {
	 .state_name = "lookup_segment_check_attr_type" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_segment_check_attr_type ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_check_attr_type_trtbl 
};

static struct PINT_tran_tbl_s ST_lookup_segment_check_attr_type_trtbl[] = {
	{ .return_value = LOOKUP_TYPE_DIRECTORY ,
	 .next_state = &ST_lookup_context_check_completion },
	{ .return_value = LOOKUP_TYPE_METAFILE ,
	 .next_state = &ST_lookup_context_check_completion },
	{ .return_value = LOOKUP_TYPE_LN_NO_FOLLOW ,
	 .next_state = &ST_lookup_context_check_completion },
	{ .return_value = LOOKUP_TYPE_RELATIVE_LN ,
	 .next_state = &ST_lookup_segment_handle_relative_link },
	{ .return_value = LOOKUP_TYPE_ABSOLUTE_LN ,
	 .next_state = &ST_lookup_segment_handle_absolute_link },
	{ .return_value = -1 ,
	 .next_state = &ST_lookup_cleanup }
};

static struct PINT_state_s ST_lookup_context_check_completion = {
	 .state_name = "lookup_context_check_completion" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_context_check_completion ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_context_check_completion_trtbl 
};

static struct PINT_tran_tbl_s ST_lookup_context_check_completion_trtbl[] = {
	{ .return_value = LOOKUP_CONTINUE ,
	 .next_state = &ST_lookup_segment_start },
	{ .return_value = -1 ,
	 .next_state = &ST_lookup_cleanup }
};

static struct PINT_state_s ST_lookup_segment_handle_relative_link = {
	 .state_name = "lookup_segment_handle_relative_link" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_segment_handle_relative_link ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_handle_relative_link_trtbl 
};
...
static struct PINT_state_s ST_lookup_segment_handle_absolute_link = {
	 .state_name = "lookup_segment_handle_absolute_link" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_segment_handle_absolute_link ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_segment_handle_absolute_link_trtbl 
};
...
static struct PINT_state_s ST_lookup_cleanup = {
	 .state_name = "lookup_cleanup" ,
	 .parent_machine = &pvfs2_client_lookup_sm ,
	 .flag = SM_RUN ,
	 .action.func = lookup_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_lookup_cleanup_trtbl 
};
...
#ifndef WIN32
# 166 "src/client/sysint/sys-lookup.sm"
#endif
