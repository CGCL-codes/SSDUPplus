...
static struct PINT_state_s ST_setup_msgpair = {
	 ...
	 .flag = SM_RUN ,
	 .action.func = mgmt_noop_setup_msgpair ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 53 "src/client/sysint/mgmt-noop.sm"
#endif
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    PINT_SERVREQ_MGMT_NOOP_FILL(sm_p->msgarray_op.msgpair.req, capability, sm_p->hints);
