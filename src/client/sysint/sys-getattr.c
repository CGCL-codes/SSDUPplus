...
static int getattr_datafile_getattr_comp_fn(
    void *v_p, struct PVFS_server_resp *resp_p, int index);
static int getattr_dirdata_getattr_comp_fn(
    void *v_p, struct PVFS_server_resp *resp_p, int index);
...
static struct PINT_state_s ST_datafile_getattr_retry;
static struct PINT_pjmp_tbl_s ST_datafile_getattr_retry_pjtbl[];
static struct PINT_tran_tbl_s ST_datafile_getattr_retry_trtbl[];
...
static struct PINT_tran_tbl_s ST_datafile_getattr_xfer_msgpairarray_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_datafile_getattr_retry }
};

static struct PINT_state_s ST_datafile_getattr_retry = {
	 .state_name = "datafile_getattr_retry" ,
	 .parent_machine = &pvfs2_client_datafile_getattr_sizes_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_datafile_getattr_retry ,
	 .pjtbl = NULL ,
	 .trtbl = ST_datafile_getattr_retry_trtbl 
};

static struct PINT_tran_tbl_s ST_datafile_getattr_retry_trtbl[] = {
	{ .return_value = GETATTR_IO_RETRY ,
	 .next_state = &ST_datafile_getattr_xfer_msgpairarray },
	{ .return_value = -1 ,
	 .next_state = &ST_datafile_getattr_cleanup }
};
...
static struct PINT_state_s ST_dirdata_getattr_setup_msgpairarray;
static struct PINT_pjmp_tbl_s ST_dirdata_getattr_setup_msgpairarray_pjtbl[];
static struct PINT_tran_tbl_s ST_dirdata_getattr_setup_msgpairarray_trtbl[];
static struct PINT_state_s ST_dirdata_getattr_xfer_msgpairarray;
static struct PINT_pjmp_tbl_s ST_dirdata_getattr_xfer_msgpairarray_pjtbl[];
static struct PINT_tran_tbl_s ST_dirdata_getattr_xfer_msgpairarray_trtbl[];

static PINT_sm_action getattr_dirdata_getattr_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_dirdata_getattr_cleanup;
static struct PINT_pjmp_tbl_s ST_dirdata_getattr_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_dirdata_getattr_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_client_dirdata_getattr_sm = {
	.name = "pvfs2_client_dirdata_getattr_sm",
	.first_state = &ST_dirdata_getattr_setup_msgpairarray
};

static struct PINT_state_s ST_dirdata_getattr_setup_msgpairarray = {
	 .state_name = "dirdata_getattr_setup_msgpairarray" ,
	 .parent_machine = &pvfs2_client_dirdata_getattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_dirdata_getattr_setup_msgpairarray ,
	 .pjtbl = NULL ,
	 .trtbl = ST_dirdata_getattr_setup_msgpairarray_trtbl 
};

static struct PINT_tran_tbl_s ST_dirdata_getattr_setup_msgpairarray_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_dirdata_getattr_xfer_msgpairarray },
	{ .return_value = -1 ,
	 .next_state = &ST_dirdata_getattr_cleanup }
};

static struct PINT_state_s ST_dirdata_getattr_xfer_msgpairarray = {
	 .state_name = "dirdata_getattr_xfer_msgpairarray" ,
	 .parent_machine = &pvfs2_client_dirdata_getattr_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_dirdata_getattr_xfer_msgpairarray_trtbl 
};
...
static struct PINT_state_s ST_dirdata_getattr_cleanup = {
	 .state_name = "dirdata_getattr_cleanup" ,
	 .parent_machine = &pvfs2_client_dirdata_getattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_dirdata_getattr_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_dirdata_getattr_cleanup_trtbl 
};
...
static PINT_sm_action getattr_client_capcache_lookup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_client_capcache_lookup;
static struct PINT_pjmp_tbl_s ST_client_capcache_lookup_pjtbl[];
static struct PINT_tran_tbl_s ST_client_capcache_lookup_trtbl[];
...
static PINT_sm_action getattr_client_capcache_insert(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_client_capcache_insert;
static struct PINT_pjmp_tbl_s ST_client_capcache_insert_pjtbl[];
static struct PINT_tran_tbl_s ST_client_capcache_insert_trtbl[];
...
static struct PINT_state_s ST_attr_mask_include_size;
static struct PINT_pjmp_tbl_s ST_attr_mask_include_size_pjtbl[];
static struct PINT_tran_tbl_s ST_attr_mask_include_size_trtbl[];
static struct PINT_state_s ST_dirdata_get_attrs;
static struct PINT_pjmp_tbl_s ST_dirdata_get_attrs_pjtbl[];
static struct PINT_tran_tbl_s ST_dirdata_get_attrs_trtbl[];
...
static struct PINT_tran_tbl_s ST_acache_lookup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_client_capcache_lookup }
};

static struct PINT_state_s ST_client_capcache_lookup = {
	 .state_name = "client_capcache_lookup" ,
	 .parent_machine = &pvfs2_client_getattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_client_capcache_lookup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_client_capcache_lookup_trtbl 
};

static struct PINT_tran_tbl_s ST_client_capcache_lookup_trtbl[] = {
	{ .return_value = GETATTR_CACHE_MISS ,
...
static struct PINT_tran_tbl_s ST_object_getattr_xfer_msgpair_trtbl[] = {
	...
	{ .return_value = GETATTR_NEED_DIRDATA_ATTRS ,
	 .next_state = &ST_dirdata_get_attrs },
	{ .return_value = -1 ,
...
static struct PINT_tran_tbl_s ST_acache_insert_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_client_capcache_insert }
};

static struct PINT_state_s ST_client_capcache_insert = {
	 .state_name = "client_capcache_insert" ,
	 .parent_machine = &pvfs2_client_getattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_client_capcache_insert ,
	 .pjtbl = NULL ,
	 .trtbl = ST_client_capcache_insert_trtbl 
};
...
static struct PINT_tran_tbl_s ST_datafile_get_sizes_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_attr_mask_include_size },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_attr_mask_include_size = {
	 .state_name = "attr_mask_include_size" ,
	 .parent_machine = &pvfs2_client_getattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = attr_mask_include_size ,
	 .pjtbl = NULL ,
	 .trtbl = ST_attr_mask_include_size_trtbl 
};
...
static struct PINT_state_s ST_dirdata_get_attrs = {
	 .state_name = "dirdata_get_attrs" ,
	 .parent_machine = &pvfs2_client_getattr_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_dirdata_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_dirdata_get_attrs_trtbl 
};
...
#ifndef WIN32
# 207 "src/client/sysint/sys-getattr.sm"
#endif
 ...
 * </li>
 * <li><b>default (0)</b> - The requested attribute was found in
 * the attribute cache and its mask values were sufficient.
 * </li>
 *
                                            ...
                                            job_status_s *js_p)
{
    ...
    gossip_debug(GOSSIP_CLIENT_DEBUG, "%s: called on behalf of %s\n",
    ...
    gossip_debug(GOSSIP_ACACHE_DEBUG, "%s: request attrmask:\n", __func__);
    PINT_attrmask_print(GOSSIP_ACACHE_DEBUG, sm_p->getattr.req_attrmask);

    gossip_debug(GOSSIP_ACACHE_DEBUG, "%s: returned attrmask:\n", __func__);
    ...
    gossip_debug(GOSSIP_ACACHE_DEBUG, "%s: trimmed attrmask:\n", __func__);
    PINT_attrmask_print(GOSSIP_ACACHE_DEBUG, trimmed_mask);
    ...
    if (missing_attrs == 0)
    {
        gossip_debug(GOSSIP_ACACHE_DEBUG, "%s: NO ATTRS MISSING.\n", __func__);
                                                     ...
                                                     job_status_s *js_p)
{
    ...
    else
    {
        if (ret == -PVFS_ENOENT)
        {
            gossip_debug(GOSSIP_CLIENT_DEBUG, "%s: client capcache miss\n", 
                         __func__);
        }
        else if (ret == -PVFS_ETIME)
        {
            gossip_debug(GOSSIP_CLIENT_DEBUG, "%s: client capcache timeout\n",
                         __func__);
        }
        else
        {
            gossip_debug(GOSSIP_CLIENT_DEBUG, "%s: client capcache error "
                         "%d\n", __func__, ret);
        }
                                          ...
                                          int index)
{
    ...
    {
        PINT_debug_capability(&attr->capability, "getattr received");
    }

    if (sm_p->getattr.flags & PINT_SM_GETATTR_CAPCACHE_HIT)
    {
        /* add back in capability flag (already stored in attr) */
        attr->mask |= PVFS_ATTR_CAPABILITY;
        PINT_debug_capability(&attr->capability, "getattr used cached");
    }
    ...
    switch (attr->objtype)
    {
        case PVFS_TYPE_METAFILE:
            gossip_debug(GOSSIP_GETATTR_DEBUG, "%s: objtype = METAFILE\n", __func__);
        ...
        {            
            ...
            gossip_debug(GOSSIP_GETATTR_DEBUG, "%s: objtype = DIRECTORY\n", __func__);
            ...
            if(attr->mask & PVFS_ATTR_DISTDIR_ATTR)
            {
                ...
                for(tmp_i = attr->dist_dir_attr.bitmap_size - 1;
                        tmp_i >= 0 ; tmp_i--)
                {
                    c = (unsigned char *)(attr->dist_dir_bitmap + tmp_i);
                        ...
                        dirent_file_count_i++)
                {
                    gossip_debug(GOSSIP_CLIENT_DEBUG,
                            ...
                            dirent_file_count_i,
                            llu(attr->dirdata_handles[dirent_file_count_i]));
                }
            }
              ...
              )
            {
                ...
                gossip_debug(GOSSIP_CLIENT_DEBUG,
                        "  !!! need to contact dirdata to gather dirent_count and timestamps!\n");
        ...
        job_status_s *js_p)
{
    ...
    uint64_t mirror_retry =
                    (sm_p->getattr.attr.mask & PVFS_ATTR_META_MIRROR_DFILES);
    PVFS_handle *handles;
    PVFS_capability capability;
...
{           
    ...
    /* Initialize size_array, used to store the dirent_count of every
     * dirdata handle.
     */
    ...
    {
        if(PINT_is_dist_dir_bucket_active(&attr->dist_dir_attr,
                    attr->dist_dir_bitmap, i))
        {
    ...
    foreach_msgpair(&sm_p->msgarray_op, msg_p, i)
    {
        ...
        gossip_debug(GOSSIP_CLIENT_DEBUG,
                     "getattr: posting dirdata getattr[%d] ([%d]:%lld,%d)\n",
                     i, cur_index,
                     llu(attr->dirdata_handles[cur_index]),
                     sm_p->getattr.object_ref.fs_id);
        ...
        PINT_SERVREQ_GETATTR_FILL(
            ...
            *sm_p->cred_p,
            sm_p->getattr.object_ref.fs_id,
            attr->dirdata_handles[cur_index],
            PVFS_ATTR_COMMON_ALL|PVFS_ATTR_DIR_DIRENT_COUNT, /* only interested in timestamp and dirent_count */
            sm_p->hints);

        /* fill in msgpair structure components */
        msg_p->fs_id = sm_p->getattr.object_ref.fs_id;
        msg_p->handle = attr->dirdata_handles[cur_index];
        msg_p->retry_flag = PVFS_MSGPAIR_RETRY;
    ...
    void *v_p, struct PVFS_server_resp *resp_p, int index)
{
    ...
    assert( (cur_index >= 0) &&
            (cur_index < attr_p->dist_dir_attr.num_servers));

    gossip_debug(GOSSIP_CLIENT_DEBUG, "dirdata getattr[%d] (#[%d]) returns attrs: "
    ...
    /* Flipping on PVFS_ATTR_DIR_DIRENT_COUNT here is required for acache
     * functionalilty. */
    attr_p->mask |= PVFS_ATTR_DIR_DIRENT_COUNT;
    gossip_debug(GOSSIP_GETATTR_DEBUG,
                 "%s: dirent_count = %lld\n",
                 __func__,
                 lld(attr_p->u.dir.dirent_count));
        ...
        sm_p->getattr.attr.objtype == PVFS_TYPE_SYMLINK )
    {
            ...
            sm_p->getattr.req_attrmask & PVFS_ATTR_DATA_SIZE)
        {
            ...
            else
            {
                ...
                tmp_size = &sm_p->getattr.size;
                gossip_debug(GOSSIP_ACACHE_DEBUG,
                             "%s: calculated unstuffed logical size of %lld\n",
                             __func__,
                             lld(*tmp_size));
            }
        }
            ...
            sm_p->getattr.req_attrmask & PVFS_ATTR_DIR_DIRENT_COUNT)
        {
            ...
            gossip_debug(GOSSIP_ACACHE_DEBUG,
                         ...
                         "handle=%llu size_array=%p num_servers=%d\n",
                         __func__,
                         llu(sm_p->getattr.object_ref.handle),
                         (void *) sm_p->getattr.size_array,
                                                     ...
                                                     job_status_s *js_p)
{
    ...
    {
        gossip_err("%s: could not get local uid for client capcache\n",
                   __func__);
    }
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    /* Clean up size array if not asked to keep.
     * It is allocated if datafile sizes or dirent_count are retrieved */
    ...
    if (js_p->error_code == 0)
    {
            ...
            (attr->mask & PVFS_ATTR_META_DFILES))
        {
            ...
            sysresp->attr.blksize = attr->u.meta.dist->methods->get_blksize(
                attr->u.meta.dist->params, attr->u.meta.dfile_count);
