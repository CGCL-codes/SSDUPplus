...
struct PINT_state_machine_s pvfs2_client_mgmt_get_uid_list_sm = {
	.name = "pvfs2_client_mgmt_get_uid_list_sm",
	.first_state = &ST_setup_msgpair
};

static struct PINT_state_s ST_setup_msgpair = {
	 .state_name = "setup_msgpair" ,
	 .parent_machine = &pvfs2_client_mgmt_get_uid_list_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_get_uid_list_setup_msgpair ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_client_mgmt_get_uid_list_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_get_uid_list_cleanup ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 49 "src/client/sysint/mgmt-get-uid-list.sm"
#endif
    ...
    void *user_ptr)
{
    ...
    ret = PVFS_imgmt_get_uid_list(fs_id, credential, server_count, addr_array,
