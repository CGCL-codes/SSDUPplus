...
static struct PINT_state_s ST_rename_parent_getattr_setup_msgpair_array;
static struct PINT_pjmp_tbl_s ST_rename_parent_getattr_setup_msgpair_array_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_parent_getattr_setup_msgpair_array_trtbl[];
static struct PINT_state_s ST_rename_parent_getattr_xfer_msgpair_array;
static struct PINT_pjmp_tbl_s ST_rename_parent_getattr_xfer_msgpair_array_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_parent_getattr_xfer_msgpair_array_trtbl[];

static PINT_sm_action rename_lookups_setup_msgpair_array(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_lookups_setup_msgpair_array;
static struct PINT_pjmp_tbl_s ST_rename_lookups_setup_msgpair_array_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_lookups_setup_msgpair_array_trtbl[];
static struct PINT_state_s ST_rename_lookups_xfer_msgpair_array;
static struct PINT_pjmp_tbl_s ST_rename_lookups_xfer_msgpair_array_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_lookups_xfer_msgpair_array_trtbl[];
static struct PINT_state_s ST_rename_getattr_src;
static struct PINT_pjmp_tbl_s ST_rename_getattr_src_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_getattr_src_trtbl[];

static PINT_sm_action rename_getattr_src_interpret(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_getattr_src_interpret;
static struct PINT_pjmp_tbl_s ST_rename_getattr_src_interpret_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_getattr_src_interpret_trtbl[];
static struct PINT_state_s ST_rename_getattr_dest;
static struct PINT_pjmp_tbl_s ST_rename_getattr_dest_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_getattr_dest_trtbl[];

static PINT_sm_action rename_parent_getattr_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_parent_getattr_failure;
static struct PINT_pjmp_tbl_s ST_rename_parent_getattr_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_parent_getattr_failure_trtbl[];

static PINT_sm_action rename_lookups_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_lookups_failure;
static struct PINT_pjmp_tbl_s ST_rename_lookups_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_lookups_failure_trtbl[];

static PINT_sm_action rename_crdirent_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_crdirent_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_rename_crdirent_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_crdirent_setup_msgpair_trtbl[];
static struct PINT_state_s ST_rename_crdirent_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_rename_crdirent_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_crdirent_xfer_msgpair_trtbl[];

static PINT_sm_action rename_crdirent_retry_or_fail(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_crdirent_retry_or_fail;
static struct PINT_pjmp_tbl_s ST_rename_crdirent_retry_or_fail_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_crdirent_retry_or_fail_trtbl[];

static PINT_sm_action rename_crdirent_getattr_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_crdirent_getattr_setup;
static struct PINT_pjmp_tbl_s ST_crdirent_getattr_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_crdirent_getattr_setup_trtbl[];
static struct PINT_state_s ST_crdirent_getattr;
static struct PINT_pjmp_tbl_s ST_crdirent_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_crdirent_getattr_trtbl[];

static PINT_sm_action rename_crdirent_getattr_fill_dirent_handle(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_crdirent_getattr_fill_dirent_handle;
static struct PINT_pjmp_tbl_s ST_crdirent_getattr_fill_dirent_handle_pjtbl[];
static struct PINT_tran_tbl_s ST_crdirent_getattr_fill_dirent_handle_trtbl[];

static PINT_sm_action rename_generic_timer(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_crdirent_timer;
static struct PINT_pjmp_tbl_s ST_rename_crdirent_timer_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_crdirent_timer_trtbl[];

static PINT_sm_action rename_rmdirent_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_rmdirent_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_rename_rmdirent_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_rmdirent_setup_msgpair_trtbl[];
static struct PINT_state_s ST_rename_rmdirent_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_rename_rmdirent_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_rmdirent_xfer_msgpair_trtbl[];

static PINT_sm_action rename_rmdirent_retry_or_fail(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_rmdirent_retry_or_fail;
static struct PINT_pjmp_tbl_s ST_rename_rmdirent_retry_or_fail_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_rmdirent_retry_or_fail_trtbl[];

static PINT_sm_action rename_rmdirent_getattr_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rmdirent_getattr_setup;
static struct PINT_pjmp_tbl_s ST_rmdirent_getattr_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_rmdirent_getattr_setup_trtbl[];
static struct PINT_state_s ST_rmdirent_getattr;
static struct PINT_pjmp_tbl_s ST_rmdirent_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_rmdirent_getattr_trtbl[];

static PINT_sm_action rename_rmdirent_getattr_fill_dirent_handle(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rmdirent_getattr_fill_dirent_handle;
static struct PINT_pjmp_tbl_s ST_rmdirent_getattr_fill_dirent_handle_pjtbl[];
static struct PINT_tran_tbl_s ST_rmdirent_getattr_fill_dirent_handle_trtbl[];
static struct PINT_state_s ST_rename_rmdirent_timer;
static struct PINT_pjmp_tbl_s ST_rename_rmdirent_timer_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_rmdirent_timer_trtbl[];

static PINT_sm_action rename_rmdirent_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_rmdirent_failure;
static struct PINT_pjmp_tbl_s ST_rename_rmdirent_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_rmdirent_failure_trtbl[];

static PINT_sm_action rename_check_for_remove(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_check_for_remove;
static struct PINT_pjmp_tbl_s ST_rename_check_for_remove_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_check_for_remove_trtbl[];
static struct PINT_state_s ST_rename_do_remove;
static struct PINT_pjmp_tbl_s ST_rename_do_remove_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_do_remove_trtbl[];

static PINT_sm_action rename_warn_user_to_run_fsck(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_warn_user_to_run_fsck;
static struct PINT_pjmp_tbl_s ST_rename_warn_user_to_run_fsck_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_warn_user_to_run_fsck_trtbl[];

static PINT_sm_action rename_chdirent_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_chdirent_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_rename_chdirent_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_chdirent_setup_msgpair_trtbl[];
static struct PINT_state_s ST_rename_chdirent_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_rename_chdirent_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_chdirent_xfer_msgpair_trtbl[];

static PINT_sm_action rename_chdirent_retry_or_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_chdirent_retry_or_failure;
static struct PINT_pjmp_tbl_s ST_rename_chdirent_retry_or_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_chdirent_retry_or_failure_trtbl[];

static PINT_sm_action rename_chdirent_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rename_chdirent_failure;
static struct PINT_pjmp_tbl_s ST_rename_chdirent_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_rename_chdirent_failure_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_rename_sm = {
	.name = "pvfs2_client_rename_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_rename_parent_getattr_setup_msgpair_array }
};

static struct PINT_state_s ST_rename_parent_getattr_setup_msgpair_array = {
	 .state_name = "rename_parent_getattr_setup_msgpair_array" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_parent_getattr_setup_msgpair_array ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_parent_getattr_setup_msgpair_array_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_parent_getattr_setup_msgpair_array_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_parent_getattr_xfer_msgpair_array },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_parent_getattr_failure }
};

static struct PINT_state_s ST_rename_parent_getattr_xfer_msgpair_array = {
	 .state_name = "rename_parent_getattr_xfer_msgpair_array" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_parent_getattr_xfer_msgpair_array_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_parent_getattr_xfer_msgpair_array_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_lookups_setup_msgpair_array },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_parent_getattr_failure }
};

static struct PINT_state_s ST_rename_lookups_setup_msgpair_array = {
	 .state_name = "rename_lookups_setup_msgpair_array" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_lookups_setup_msgpair_array ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_lookups_setup_msgpair_array_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_lookups_setup_msgpair_array_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_lookups_xfer_msgpair_array },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_lookups_failure }
};

static struct PINT_state_s ST_rename_lookups_xfer_msgpair_array = {
	 .state_name = "rename_lookups_xfer_msgpair_array" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_lookups_xfer_msgpair_array_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_lookups_xfer_msgpair_array_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_crdirent_setup_msgpair },
	{ .return_value = RENAME_CHDIRENT ,
	 .next_state = &ST_rename_getattr_src },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_lookups_failure }
};

static struct PINT_state_s ST_rename_getattr_src = {
	 .state_name = "rename_getattr_src" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_getattr_src_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_getattr_src_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_getattr_src_interpret },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_rename_getattr_src_interpret = {
	 .state_name = "rename_getattr_src_interpret" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_getattr_src_interpret ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_getattr_src_interpret_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_getattr_src_interpret_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_rename_getattr_dest }
};

static struct PINT_state_s ST_rename_getattr_dest = {
	 .state_name = "rename_getattr_dest" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_getattr_dest_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_getattr_dest_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_chdirent_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_rename_parent_getattr_failure = {
	 .state_name = "rename_parent_getattr_failure" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_parent_getattr_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_parent_getattr_failure_trtbl 
};
...
static struct PINT_state_s ST_rename_lookups_failure = {
	 .state_name = "rename_lookups_failure" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_lookups_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_lookups_failure_trtbl 
};
...
static struct PINT_state_s ST_rename_crdirent_setup_msgpair = {
	 .state_name = "rename_crdirent_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_crdirent_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_crdirent_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_crdirent_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_crdirent_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_crdirent_retry_or_fail }
};

static struct PINT_state_s ST_rename_crdirent_xfer_msgpair = {
	 .state_name = "rename_crdirent_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_crdirent_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_crdirent_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_rmdirent_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_crdirent_retry_or_fail }
};

static struct PINT_state_s ST_rename_crdirent_retry_or_fail = {
	 .state_name = "rename_crdirent_retry_or_fail" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_crdirent_retry_or_fail ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_crdirent_retry_or_fail_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_crdirent_retry_or_fail_trtbl[] = {
	{ .return_value = RENAME_CRDIRENT_RETRY ,
	 .next_state = &ST_rename_crdirent_timer },
	{ .return_value = RENAME_CRDIRENT_RETRY_NEED_GETATTR ,
	 .next_state = &ST_crdirent_getattr_setup },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_crdirent_getattr_setup = {
	 .state_name = "crdirent_getattr_setup" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_crdirent_getattr_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_crdirent_getattr_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_crdirent_getattr_setup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_crdirent_getattr }
};

static struct PINT_state_s ST_crdirent_getattr = {
	 .state_name = "crdirent_getattr" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_crdirent_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_crdirent_getattr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_crdirent_getattr_fill_dirent_handle },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_crdirent_getattr_fill_dirent_handle = {
	 .state_name = "crdirent_getattr_fill_dirent_handle" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_crdirent_getattr_fill_dirent_handle ,
	 .pjtbl = NULL ,
	 .trtbl = ST_crdirent_getattr_fill_dirent_handle_trtbl 
};
...
static struct PINT_state_s ST_rename_crdirent_timer = {
	 .state_name = "rename_crdirent_timer" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_generic_timer ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_crdirent_timer_trtbl 
};
...
static struct PINT_state_s ST_rename_rmdirent_setup_msgpair = {
	 .state_name = "rename_rmdirent_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_rmdirent_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_rmdirent_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_rmdirent_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_rmdirent_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_rmdirent_retry_or_fail }
};

static struct PINT_state_s ST_rename_rmdirent_xfer_msgpair = {
	 .state_name = "rename_rmdirent_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_rmdirent_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_rmdirent_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_check_for_remove },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_rmdirent_retry_or_fail }
};

static struct PINT_state_s ST_rename_rmdirent_retry_or_fail = {
	 .state_name = "rename_rmdirent_retry_or_fail" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_rmdirent_retry_or_fail ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_rmdirent_retry_or_fail_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_rmdirent_retry_or_fail_trtbl[] = {
	{ .return_value = RENAME_RMDIRENT_RETRY ,
	 .next_state = &ST_rename_rmdirent_timer },
	{ .return_value = RENAME_RMDIRENT_RETRY_NEED_GETATTR ,
	 .next_state = &ST_rmdirent_getattr_setup },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_rmdirent_failure }
};

static struct PINT_state_s ST_rmdirent_getattr_setup = {
	 .state_name = "rmdirent_getattr_setup" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_rmdirent_getattr_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rmdirent_getattr_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_rmdirent_getattr_setup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_rmdirent_getattr }
};

static struct PINT_state_s ST_rmdirent_getattr = {
	 .state_name = "rmdirent_getattr" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rmdirent_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_rmdirent_getattr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rmdirent_getattr_fill_dirent_handle },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_rmdirent_getattr_fill_dirent_handle = {
	 .state_name = "rmdirent_getattr_fill_dirent_handle" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_rmdirent_getattr_fill_dirent_handle ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rmdirent_getattr_fill_dirent_handle_trtbl 
};
...
static struct PINT_state_s ST_rename_rmdirent_timer = {
	 .state_name = "rename_rmdirent_timer" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_generic_timer ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_rmdirent_timer_trtbl 
};
...
static struct PINT_state_s ST_rename_rmdirent_failure = {
	 .state_name = "rename_rmdirent_failure" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_rmdirent_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_rmdirent_failure_trtbl 
};
...
static struct PINT_tran_tbl_s ST_rename_rmdirent_failure_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_rmdirent_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_warn_user_to_run_fsck }
};

static struct PINT_state_s ST_rename_check_for_remove = {
	 .state_name = "rename_check_for_remove" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_check_for_remove ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_check_for_remove_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_check_for_remove_trtbl[] = {
	{ .return_value = RENAME_REMOVE_REQUIRED ,
	 .next_state = &ST_rename_do_remove },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_rename_do_remove = {
	 .state_name = "rename_do_remove" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_remove_helper_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_do_remove_trtbl 
};
...
static struct PINT_state_s ST_rename_warn_user_to_run_fsck = {
	 .state_name = "rename_warn_user_to_run_fsck" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_warn_user_to_run_fsck ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_warn_user_to_run_fsck_trtbl 
};
...
static struct PINT_state_s ST_rename_chdirent_setup_msgpair = {
	 .state_name = "rename_chdirent_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_chdirent_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_chdirent_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_chdirent_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_chdirent_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_chdirent_failure }
};

static struct PINT_state_s ST_rename_chdirent_xfer_msgpair = {
	 .state_name = "rename_chdirent_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_chdirent_xfer_msgpair_trtbl 
};
...
static struct PINT_tran_tbl_s ST_rename_chdirent_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rename_rmdirent_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_chdirent_retry_or_failure }
};

static struct PINT_state_s ST_rename_chdirent_retry_or_failure = {
	 .state_name = "rename_chdirent_retry_or_failure" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_chdirent_retry_or_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_chdirent_retry_or_failure_trtbl 
};

static struct PINT_tran_tbl_s ST_rename_chdirent_retry_or_failure_trtbl[] = {
	{ .return_value = RENAME_CHDIRENT_RETRY ,
	 .next_state = &ST_rename_parent_getattr_setup_msgpair_array },
	{ .return_value = -1 ,
	 .next_state = &ST_rename_chdirent_failure }
};
...
static struct PINT_state_s ST_rename_chdirent_failure = {
	 .state_name = "rename_chdirent_failure" ,
	 .parent_machine = &pvfs2_client_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_chdirent_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rename_chdirent_failure_trtbl 
};
...
#ifndef WIN32
# 282 "src/client/sysint/sys-rename.sm"
#endif
    ...
    PVFS_hint hints)
{
    ...
    ret = PVFS_isys_rename(old_entry, old_parent_ref, new_entry,
                           new_parent_ref, credential, &op_id, hints, NULL);
    if (ret)
    {
...
static int rename_parent_getattr_comp_fn(
    void *v_p,
    ...
    int index)
{
    ...
    /* gossip attr */
    gossip_debug(GOSSIP_CLIENT_DEBUG, "parent getattr[%d] for parent dir handle %llu "
            "with tree_height=%d, num_servers=%d, bitmap_size=%d, "
            "split_size=%d, server_no=%d and branch_level=%d\n",
            index,
            llu(sm_p->u.rename.parent_refns[index].handle),
    ...
    /* Copy capability */
    PINT_copy_capability(&attr->capability, &sm_p->u.rename.caps[index]);
    ...
    */
    ...
    /* gossip hash */
    gossip_debug(GOSSIP_CLIENT_DEBUG, "rename: encrypt dirent %s into hash value %llu.\n",
            sm_p->u.rename.entries[index],
            llu(hash));

    dirdata_index = PINT_find_dist_dir_bucket(hash, 
            &attr->dist_dir_attr, attr->dist_dir_bitmap);
    /* stash dirent_handle */
    sm_p->u.rename.dirent_handle[index] =
        attr->dirdata_handles[dirdata_index];
    gossip_debug(GOSSIP_CLIENT_DEBUG, "rename: selecting dirdata_servers[%d]=%llu"
            " as the dirent_handle for dirent %s.\n",
            dirdata_index, llu(attr->dirdata_handles[dirdata_index]),
            sm_p->u.rename.entries[index]);
    ...
    int index)
{
    ...
    */
    ...
    /* dirent_handle retrieved already
    sm_p->u.rename.dirent_handle[index] =
    ...
    {
        gossip_debug(GOSSIP_CLIENT_DEBUG,
            "*** Looked up old handle %llu, dirent_handle %llu\n",
            llu(sm_p->u.rename.refns[index].handle),
            llu(sm_p->u.rename.dirent_handle[index]));
    }
    else
    {
        assert(index == 1);
        gossip_debug(GOSSIP_CLIENT_DEBUG,
            "*** Looked up new handle %llu, dirent_handle %llu\n",
            llu(sm_p->u.rename.refns[index].handle),
            llu(sm_p->u.rename.dirent_handle[index]));
        /*
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    {
        gossip_debug(GOSSIP_CLIENT_DEBUG,
                "rename_chdirent: RETRY!! back to rename_parent_getattr_setup_msgpair_array!\n");
    ...
    if ((sm_p->u.rename.parent_refns[0].fs_id ==
        ...
        (sm_p->u.rename.parent_refns[0].handle ==
    ...
    foreach_msgpair(&sm_p->msgarray_op, msg_p, i)
    {
        ...
        gossip_debug(GOSSIP_CLIENT_DEBUG,
                     "rename: posting parent directory getattr[%d] (%lld,%d)\n",
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    {   
        gossip_debug(GOSSIP_CLIENT_DEBUG, "rename: copied identical "
                     "capability\n");
        PINT_copy_capability(&sm_p->u.rename.caps[0],
                             &sm_p->u.rename.caps[1]);
        sm_p->u.rename.dirent_handle[1] =
                sm_p->u.rename.dirent_handle[0];
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    */
    ...
    if (ret)
    {
        gossip_err("Failed to map meta server address for handle %llu\n",
                    llu(msg_p->handle));
        js_p->error_code = ret;
    }
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    */
    PINT_SERVREQ_RMDIRENT_FILL(
        msg_p->req,
        sm_p->u.rename.caps[sm_p->u.rename.rmdirent_index],
        sm_p->u.rename.parent_refns[sm_p->u.rename.rmdirent_index].fs_id,
        sm_p->u.rename.dirent_handle[sm_p->u.rename.rmdirent_index],
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    {
        PINT_copy_capability(&sm_p->u.rename.caps[1],
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
        ...
        sm_p->u.rename.retry_count < sm_p->msgarray_op.params.retry_limit) 
    {
        ...
        /* clear acache content */
        PINT_acache_invalidate(sm_p->u.rename.parent_refns[sm_p->u.rename.rmdirent_index]);
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    hash = PINT_encrypt_dirdata(sm_p->u.rename.entries[sm_p->u.rename.rmdirent_index]);
    /* gossip hash */
    gossip_debug(GOSSIP_CLIENT_DEBUG, "rename: encrypt dirent %s into hash value %llu.\n",
            sm_p->u.rename.entries[sm_p->u.rename.rmdirent_index],
            llu(hash));
