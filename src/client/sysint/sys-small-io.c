...
static struct PINT_state_s ST_setup_msgpairs;
static struct PINT_pjmp_tbl_s ST_setup_msgpairs_pjtbl[];
static struct PINT_tran_tbl_s ST_setup_msgpairs_trtbl[];
static struct PINT_state_s ST_xfer_msgpairs;
static struct PINT_pjmp_tbl_s ST_xfer_msgpairs_pjtbl[];
static struct PINT_tran_tbl_s ST_xfer_msgpairs_trtbl[];

static PINT_sm_action small_io_check_for_retries(
	struct PINT_smcb *smcb, job_status_s *js_p);
...
static struct PINT_state_s ST_setup_msgpairs = {
	 ...
	 .flag = SM_RUN ,
	 .action.func = small_io_setup_msgpairs ,
	 .pjtbl = NULL ,
	 .trtbl = ST_setup_msgpairs_trtbl 
};
...
static struct PINT_state_s ST_check_for_retries = {
	 ...
	 .parent_machine = &pvfs2_client_small_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = small_io_check_for_retries ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_for_retries_trtbl 
};

static struct PINT_tran_tbl_s ST_check_for_retries_trtbl[] = {
	{ .return_value = MIRROR_RETRY ,
	 .next_state = &ST_xfer_msgpairs },
	{ .return_value = -1 ,
...
#ifndef WIN32
# 69 "src/client/sysint/sys-small-io.sm"
#endif
...
static int small_io_cleanup(struct PINT_smcb *smcb,
                            job_status_s *js_p)
{
    struct PINT_client_sm *sm_p = PINT_sm_frame(smcb, PINT_FRAME_CURRENT);
