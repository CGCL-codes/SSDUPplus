...
static struct PINT_state_s ST_flush_getattr;
static struct PINT_pjmp_tbl_s ST_flush_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_flush_getattr_trtbl[];

static PINT_sm_action flush_datafile_setup_msgpairarray(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_flush_datafile_setup_msgpairarray;
static struct PINT_pjmp_tbl_s ST_flush_datafile_setup_msgpairarray_pjtbl[];
static struct PINT_tran_tbl_s ST_flush_datafile_setup_msgpairarray_trtbl[];
static struct PINT_state_s ST_flush_datafile_xfer_msgpairarray;
static struct PINT_pjmp_tbl_s ST_flush_datafile_xfer_msgpairarray_pjtbl[];
static struct PINT_tran_tbl_s ST_flush_datafile_xfer_msgpairarray_trtbl[];

static PINT_sm_action flush_datafile_flush_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_flush_datafile_flush_failure;
static struct PINT_pjmp_tbl_s ST_flush_datafile_flush_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_flush_datafile_flush_failure_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_flush_sm = {
	.name = "pvfs2_client_flush_sm",
	.first_state = &ST_flush_getattr
};

static struct PINT_state_s ST_flush_getattr = {
	 .state_name = "flush_getattr" ,
	 .parent_machine = &pvfs2_client_flush_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_flush_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_flush_getattr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_flush_datafile_setup_msgpairarray },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_flush_datafile_setup_msgpairarray = {
	 .state_name = "flush_datafile_setup_msgpairarray" ,
	 .parent_machine = &pvfs2_client_flush_sm ,
	 .flag = SM_RUN ,
	 .action.func = flush_datafile_setup_msgpairarray ,
	 .pjtbl = NULL ,
	 .trtbl = ST_flush_datafile_setup_msgpairarray_trtbl 
};

static struct PINT_tran_tbl_s ST_flush_datafile_setup_msgpairarray_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_flush_datafile_xfer_msgpairarray },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_flush_datafile_xfer_msgpairarray = {
	 .state_name = "flush_datafile_xfer_msgpairarray" ,
	 .parent_machine = &pvfs2_client_flush_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_flush_datafile_xfer_msgpairarray_trtbl 
};
...
static struct PINT_tran_tbl_s ST_flush_datafile_xfer_msgpairarray_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_cleanup },
	{ .return_value = -1 ,
	 .next_state = &ST_flush_datafile_flush_failure }
};

static struct PINT_state_s ST_flush_datafile_flush_failure = {
	 .state_name = "flush_datafile_flush_failure" ,
	 .parent_machine = &pvfs2_client_flush_sm ,
	 .flag = SM_RUN ,
	 .action.func = flush_datafile_flush_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_flush_datafile_flush_failure_trtbl 
};
...
#ifndef WIN32
# 66 "src/client/sysint/sys-flush.sm"
#endif
