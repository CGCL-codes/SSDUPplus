...
static PINT_sm_action set_eattr_setup_msgpair(
...
static PINT_sm_action set_eattr_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);
...
struct PINT_state_machine_s pvfs2_client_set_eattr_sm = {
	.name = "pvfs2_client_set_eattr_sm",
	.first_state = &ST_getattr
};

static struct PINT_state_s ST_getattr = {
	 .state_name = "getattr" ,
	 .parent_machine = &pvfs2_client_set_eattr_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_state_s ST_setup_msgpair = {
	 ...
	 .parent_machine = &pvfs2_client_set_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = set_eattr_setup_msgpair ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 63 "src/client/sysint/sys-set-eattr.sm"
#endif
...
PVFS_error PVFS_isys_seteattr(
        ...
        void *user_ptr)
{
    return PVFS_isys_seteattr_list(ref, credential, 1, key_p, val_p, flags,
                                op_id, hints, user_ptr);
}
...
PVFS_error PVFS_sys_seteattr(
        ...
        PVFS_hint hints)
{
    return PVFS_sys_seteattr_list(ref, credential, 1, key_p, val_p, flags, hints);
}
