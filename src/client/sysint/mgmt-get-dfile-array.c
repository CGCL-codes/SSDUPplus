...
struct PINT_state_machine_s pvfs2_client_mgmt_get_dfile_array_sm = {
	.name = "pvfs2_client_mgmt_get_dfile_array_sm",
	.first_state = &ST_getattr
};

static struct PINT_state_s ST_getattr = {
	 .state_name = "getattr" ,
	 .parent_machine = &pvfs2_client_mgmt_get_dfile_array_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_client_mgmt_get_dfile_array_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_get_dfile_array_cleanup ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 46 "src/client/sysint/mgmt-get-dfile-array.sm"
#endif
