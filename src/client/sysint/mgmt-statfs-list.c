...
struct PINT_state_machine_s pvfs2_client_mgmt_statfs_list_nested_sm = {
	.name = "pvfs2_client_mgmt_statfs_list_nested_sm",
	.first_state = &ST_setup_msgpair
};

static struct PINT_state_s ST_setup_msgpair = {
	 .state_name = "setup_msgpair" ,
	 .parent_machine = &pvfs2_client_mgmt_statfs_list_nested_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_statfs_list_setup_msgpair ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_client_mgmt_statfs_list_nested_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_statfs_list_cleanup ,
	 .pjtbl = NULL ,
...
struct PINT_state_machine_s pvfs2_client_mgmt_statfs_list_sm = {
	.name = "pvfs2_client_mgmt_statfs_list_sm",
	.first_state = &ST_run_nested
};

static struct PINT_state_s ST_run_nested = {
	 .state_name = "run_nested" ,
	 .parent_machine = &pvfs2_client_mgmt_statfs_list_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_mgmt_statfs_list_nested_sm ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_parent_cleanup = {
	 ...
	 .parent_machine = &pvfs2_client_mgmt_statfs_list_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_statfs_list_parent_cleanup ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 73 "src/client/sysint/mgmt-statfs-list.sm"
#endif
