...
static struct PINT_state_s ST_get_dirdata_handle_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_get_dirdata_handle_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_get_dirdata_handle_setup_msgpair_trtbl[];
static struct PINT_state_s ST_get_dirdata_handle_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_get_dirdata_handle_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_get_dirdata_handle_xfer_msgpair_trtbl[];
...
static struct PINT_state_s ST_init = {
	 ...
	 .flag = SM_RUN ,
	 .action.func = mgmt_get_dirdata_handle_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};
...
static struct PINT_state_s ST_get_dirdata_handle_setup_msgpair = {
	 ...
	 .parent_machine = &pvfs2_client_mgmt_get_dirdata_handle_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_get_dirdata_handle_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_dirdata_handle_setup_msgpair_trtbl 
};
...
static struct PINT_state_s ST_get_dirdata_handle_xfer_msgpair = {
	 ...
	 .pjtbl = NULL ,
	 .trtbl = ST_get_dirdata_handle_xfer_msgpair_trtbl 
};
...
#ifndef WIN32
# 64 "src/client/sysint/mgmt-get-dirdata-handle.sm"
#endif
