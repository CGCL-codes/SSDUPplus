...
static struct PINT_state_s ST_tree_setattr_do_work;
static struct PINT_pjmp_tbl_s ST_tree_setattr_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_setattr_do_work_trtbl[];
static struct PINT_state_s ST_tree_setattr_final_response;
static struct PINT_pjmp_tbl_s ST_tree_setattr_final_response_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_setattr_final_response_trtbl[];

static PINT_sm_action tree_setattr_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_setattr_cleanup;
static struct PINT_pjmp_tbl_s ST_tree_setattr_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_setattr_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_tree_setattr_sm = {
	.name = "pvfs2_tree_setattr_sm",
	.first_state = &ST_tree_setattr_do_work
};

static struct PINT_state_s ST_tree_setattr_do_work = {
	 .state_name = "tree_setattr_do_work" ,
	 .parent_machine = &pvfs2_tree_setattr_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_tree_setattr_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_setattr_do_work_trtbl 
};

static struct PINT_tran_tbl_s ST_tree_setattr_do_work_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_setattr_final_response }
};

static struct PINT_state_s ST_tree_setattr_final_response = {
	 .state_name = "tree_setattr_final_response" ,
	 .parent_machine = &pvfs2_tree_setattr_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_final_response_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_setattr_final_response_trtbl 
};

static struct PINT_tran_tbl_s ST_tree_setattr_final_response_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_setattr_cleanup }
};

static struct PINT_state_s ST_tree_setattr_cleanup = {
	 .state_name = "tree_setattr_cleanup" ,
	 .parent_machine = &pvfs2_tree_setattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = tree_setattr_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_setattr_cleanup_trtbl 
};
...
static PINT_sm_action tree_setattr_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_setattr_work_do_work;
static struct PINT_pjmp_tbl_s ST_tree_setattr_work_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_setattr_work_do_work_trtbl[];

static PINT_sm_action tree_setattr_work_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_setattr_work_cleanup;
static struct PINT_pjmp_tbl_s ST_tree_setattr_work_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_setattr_work_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_tree_setattr_work_sm = {
	.name = "pvfs2_tree_setattr_work_sm",
	.first_state = &ST_tree_setattr_work_do_work
};

static struct PINT_state_s ST_tree_setattr_work_do_work = {
	 .state_name = "tree_setattr_work_do_work" ,
	 .parent_machine = &pvfs2_tree_setattr_work_sm ,
	 .flag = SM_PJMP ,
	 .action.func = &tree_setattr_setup ,
	 .pjtbl = ST_tree_setattr_work_do_work_pjtbl ,
	 .trtbl = ST_tree_setattr_work_do_work_trtbl 
};

static struct PINT_pjmp_tbl_s ST_tree_setattr_work_do_work_pjtbl[] = {
	{ .return_value = REMOTE_OPERATION ,

	 .state_machine = &pvfs2_pjmp_call_msgpairarray_sm },
	{ .return_value = LOCAL_OPERATION ,

	 .state_machine = &pvfs2_pjmp_set_attr_work_sm }
};

static struct PINT_tran_tbl_s ST_tree_setattr_work_do_work_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_setattr_work_cleanup }
};

static struct PINT_state_s ST_tree_setattr_work_cleanup = {
	 .state_name = "tree_setattr_work_cleanup" ,
	 .parent_machine = &pvfs2_tree_setattr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = tree_setattr_work_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_setattr_work_cleanup_trtbl 
};
...
static struct PINT_state_s ST_tree_remove_do_work;
static struct PINT_pjmp_tbl_s ST_tree_remove_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_remove_do_work_trtbl[];
static struct PINT_state_s ST_tree_remove_final_response;
static struct PINT_pjmp_tbl_s ST_tree_remove_final_response_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_remove_final_response_trtbl[];

static PINT_sm_action tree_remove_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_remove_cleanup;
static struct PINT_pjmp_tbl_s ST_tree_remove_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_remove_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_tree_remove_sm = {
	.name = "pvfs2_tree_remove_sm",
	.first_state = &ST_tree_remove_do_work
};

static struct PINT_state_s ST_tree_remove_do_work = {
	 .state_name = "tree_remove_do_work" ,
	 .parent_machine = &pvfs2_tree_remove_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_tree_remove_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_remove_do_work_trtbl 
};

static struct PINT_tran_tbl_s ST_tree_remove_do_work_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_remove_final_response }
};

static struct PINT_state_s ST_tree_remove_final_response = {
	 .state_name = "tree_remove_final_response" ,
	 .parent_machine = &pvfs2_tree_remove_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_final_response_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_remove_final_response_trtbl 
};

static struct PINT_tran_tbl_s ST_tree_remove_final_response_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_remove_cleanup }
};

static struct PINT_state_s ST_tree_remove_cleanup = {
	 .state_name = "tree_remove_cleanup" ,
	 .parent_machine = &pvfs2_tree_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = tree_remove_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_remove_cleanup_trtbl 
};
...
static PINT_sm_action tree_remove_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_remove_work_do_work;
static struct PINT_pjmp_tbl_s ST_tree_remove_work_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_remove_work_do_work_trtbl[];

static PINT_sm_action tree_remove_work_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_remove_work_cleanup;
static struct PINT_pjmp_tbl_s ST_tree_remove_work_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_remove_work_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_tree_remove_work_sm = {
	.name = "pvfs2_tree_remove_work_sm",
	.first_state = &ST_tree_remove_work_do_work
};

static struct PINT_state_s ST_tree_remove_work_do_work = {
	 .state_name = "tree_remove_work_do_work" ,
	 .parent_machine = &pvfs2_tree_remove_work_sm ,
	 .flag = SM_PJMP ,
	 .action.func = &tree_remove_setup ,
	 .pjtbl = ST_tree_remove_work_do_work_pjtbl ,
	 .trtbl = ST_tree_remove_work_do_work_trtbl 
};
...
static struct PINT_pjmp_tbl_s ST_tree_remove_work_do_work_pjtbl[] = {
	...
	{ .return_value = LOCAL_OPERATION ,
	 ...
	 .state_machine = &pvfs2_pjmp_remove_work_sm }
};

static struct PINT_tran_tbl_s ST_tree_remove_work_do_work_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_remove_work_cleanup }
};

static struct PINT_state_s ST_tree_remove_work_cleanup = {
	 .state_name = "tree_remove_work_cleanup" ,
	 .parent_machine = &pvfs2_tree_remove_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = tree_remove_work_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_remove_work_cleanup_trtbl 
};
...
static struct PINT_state_s ST_tree_get_file_size_do_work;
static struct PINT_pjmp_tbl_s ST_tree_get_file_size_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_get_file_size_do_work_trtbl[];
static struct PINT_state_s ST_tree_get_file_size_final_response;
static struct PINT_pjmp_tbl_s ST_tree_get_file_size_final_response_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_get_file_size_final_response_trtbl[];

static PINT_sm_action tree_get_file_size_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_get_file_size_cleanup;
static struct PINT_pjmp_tbl_s ST_tree_get_file_size_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_get_file_size_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_tree_get_file_size_sm = {
	.name = "pvfs2_tree_get_file_size_sm",
	.first_state = &ST_tree_get_file_size_do_work
};

static struct PINT_state_s ST_tree_get_file_size_do_work = {
	 .state_name = "tree_get_file_size_do_work" ,
	 .parent_machine = &pvfs2_tree_get_file_size_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_tree_get_file_size_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_get_file_size_do_work_trtbl 
};

static struct PINT_tran_tbl_s ST_tree_get_file_size_do_work_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_get_file_size_final_response }
};

static struct PINT_state_s ST_tree_get_file_size_final_response = {
	 .state_name = "tree_get_file_size_final_response" ,
	 .parent_machine = &pvfs2_tree_get_file_size_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_final_response_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_get_file_size_final_response_trtbl 
};

static struct PINT_tran_tbl_s ST_tree_get_file_size_final_response_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_get_file_size_cleanup }
};

static struct PINT_state_s ST_tree_get_file_size_cleanup = {
	 .state_name = "tree_get_file_size_cleanup" ,
	 .parent_machine = &pvfs2_tree_get_file_size_sm ,
	 .flag = SM_RUN ,
	 .action.func = tree_get_file_size_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_get_file_size_cleanup_trtbl 
};
...
static PINT_sm_action tree_get_file_size_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_get_file_size_work_do_work;
static struct PINT_pjmp_tbl_s ST_tree_get_file_size_work_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_get_file_size_work_do_work_trtbl[];

static PINT_sm_action tree_get_file_size_work_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_get_file_size_work_cleanup;
static struct PINT_pjmp_tbl_s ST_tree_get_file_size_work_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_get_file_size_work_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_tree_get_file_size_work_sm = {
	.name = "pvfs2_tree_get_file_size_work_sm",
	.first_state = &ST_tree_get_file_size_work_do_work
};

static struct PINT_state_s ST_tree_get_file_size_work_do_work = {
	 .state_name = "tree_get_file_size_work_do_work" ,
	 .parent_machine = &pvfs2_tree_get_file_size_work_sm ,
	 .flag = SM_PJMP ,
	 .action.func = &tree_get_file_size_setup ,
	 .pjtbl = ST_tree_get_file_size_work_do_work_pjtbl ,
	 .trtbl = ST_tree_get_file_size_work_do_work_trtbl 
};
...
static struct PINT_pjmp_tbl_s ST_tree_get_file_size_work_do_work_pjtbl[] = {
	...
	{ .return_value = LOCAL_OPERATION ,
	 ...
	 .state_machine = &pvfs2_pjmp_get_attr_with_prelude_sm }
};

static struct PINT_tran_tbl_s ST_tree_get_file_size_work_do_work_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_get_file_size_work_cleanup }
};

static struct PINT_state_s ST_tree_get_file_size_work_cleanup = {
	 .state_name = "tree_get_file_size_work_cleanup" ,
	 .parent_machine = &pvfs2_tree_get_file_size_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = tree_get_file_size_work_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_get_file_size_work_cleanup_trtbl 
};
...
static struct PINT_state_s ST_tree_getattr_do_work;
static struct PINT_pjmp_tbl_s ST_tree_getattr_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_getattr_do_work_trtbl[];
static struct PINT_state_s ST_tree_getattr_final_response;
static struct PINT_pjmp_tbl_s ST_tree_getattr_final_response_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_getattr_final_response_trtbl[];

static PINT_sm_action tree_getattr_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_getattr_cleanup;
static struct PINT_pjmp_tbl_s ST_tree_getattr_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_getattr_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_tree_getattr_sm = {
	.name = "pvfs2_tree_getattr_sm",
	.first_state = &ST_tree_getattr_do_work
};

static struct PINT_state_s ST_tree_getattr_do_work = {
	 .state_name = "tree_getattr_do_work" ,
	 .parent_machine = &pvfs2_tree_getattr_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_tree_getattr_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_getattr_do_work_trtbl 
};

static struct PINT_tran_tbl_s ST_tree_getattr_do_work_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_getattr_final_response }
};

static struct PINT_state_s ST_tree_getattr_final_response = {
	 .state_name = "tree_getattr_final_response" ,
	 .parent_machine = &pvfs2_tree_getattr_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_final_response_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_getattr_final_response_trtbl 
};

static struct PINT_tran_tbl_s ST_tree_getattr_final_response_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_getattr_cleanup }
};

static struct PINT_state_s ST_tree_getattr_cleanup = {
	 .state_name = "tree_getattr_cleanup" ,
	 .parent_machine = &pvfs2_tree_getattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = tree_getattr_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_getattr_cleanup_trtbl 
};
...
static PINT_sm_action tree_getattr_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_getattr_work_do_work;
static struct PINT_pjmp_tbl_s ST_tree_getattr_work_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_getattr_work_do_work_trtbl[];

static PINT_sm_action tree_getattr_work_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_tree_getattr_work_cleanup;
static struct PINT_pjmp_tbl_s ST_tree_getattr_work_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_tree_getattr_work_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_tree_getattr_work_sm = {
	.name = "pvfs2_tree_getattr_work_sm",
	.first_state = &ST_tree_getattr_work_do_work
};

static struct PINT_state_s ST_tree_getattr_work_do_work = {
	 .state_name = "tree_getattr_work_do_work" ,
	 .parent_machine = &pvfs2_tree_getattr_work_sm ,
	 .flag = SM_PJMP ,
	 .action.func = &tree_getattr_setup ,
	 .pjtbl = ST_tree_getattr_work_do_work_pjtbl ,
	 .trtbl = ST_tree_getattr_work_do_work_trtbl 
};
...
static struct PINT_tran_tbl_s ST_tree_getattr_work_do_work_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_tree_getattr_work_cleanup }
};

static struct PINT_state_s ST_tree_getattr_work_cleanup = {
	 .state_name = "tree_getattr_work_cleanup" ,
	 .parent_machine = &pvfs2_tree_getattr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = tree_getattr_work_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_tree_getattr_work_cleanup_trtbl 
};
...
#ifndef WIN32
# 213 "src/server/tree-communicate.sm"
#endif
...
static int tree_setattr_cleanup(
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    PINT_server_op *s_op = PINT_sm_frame(smcb, PINT_FRAME_CURRENT);
    struct PVFS_servresp_tree_setattr *s_tree = &(s_op->resp.u.tree_setattr);
