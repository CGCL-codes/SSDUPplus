...
static PINT_sm_action inspect_inputs(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_inspect_inputs;
static struct PINT_pjmp_tbl_s ST_inspect_inputs_pjtbl[];
static struct PINT_tran_tbl_s ST_inspect_inputs_trtbl[];
static struct PINT_state_s ST_mirror_do_work;
static struct PINT_pjmp_tbl_s ST_mirror_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_mirror_do_work_trtbl[];
...
static PINT_sm_action mirror_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_mirror_cleanup;
static struct PINT_pjmp_tbl_s ST_mirror_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_mirror_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_mirror_sm = {
	.name = "pvfs2_mirror_sm",
	.first_state = &ST_prelude
};

static struct PINT_state_s ST_prelude = {
	 .state_name = "prelude" ,
	 .parent_machine = &pvfs2_mirror_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_tran_tbl_s ST_prelude_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_inspect_inputs },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_inspect_inputs = {
	 .state_name = "inspect_inputs" ,
	 .parent_machine = &pvfs2_mirror_sm ,
	 .flag = SM_RUN ,
	 .action.func = inspect_inputs ,
	 .pjtbl = NULL ,
	 .trtbl = ST_inspect_inputs_trtbl 
};

static struct PINT_tran_tbl_s ST_inspect_inputs_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_mirror_do_work },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_mirror_do_work = {
	 .state_name = "mirror_do_work" ,
	 .parent_machine = &pvfs2_mirror_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_mirror_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mirror_do_work_trtbl 
};
...
static struct PINT_tran_tbl_s ST_final_response_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_mirror_cleanup }
};

static struct PINT_state_s ST_mirror_cleanup = {
	 .state_name = "mirror_cleanup" ,
	 .parent_machine = &pvfs2_mirror_sm ,
	 .flag = SM_RUN ,
	 .action.func = mirror_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mirror_cleanup_trtbl 
};
...
static PINT_sm_action setup_write_request(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_setup_write_request;
static struct PINT_pjmp_tbl_s ST_setup_write_request_pjtbl[];
static struct PINT_tran_tbl_s ST_setup_write_request_trtbl[];
...
static PINT_sm_action post_ack_and_flow(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_post_ack_and_flow;
static struct PINT_pjmp_tbl_s ST_post_ack_and_flow_pjtbl[];
static struct PINT_tran_tbl_s ST_post_ack_and_flow_trtbl[];

static PINT_sm_action check_comm(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_check_comm;
static struct PINT_pjmp_tbl_s ST_check_comm_pjtbl[];
static struct PINT_tran_tbl_s ST_check_comm_trtbl[];

static PINT_sm_action check_results(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_check_results;
static struct PINT_pjmp_tbl_s ST_check_results_pjtbl[];
static struct PINT_tran_tbl_s ST_check_results_trtbl[];

static PINT_sm_action cleanup_mirror_work(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_cleanup_mirror_work;
static struct PINT_pjmp_tbl_s ST_cleanup_mirror_work_pjtbl[];
static struct PINT_tran_tbl_s ST_cleanup_mirror_work_trtbl[];

struct PINT_state_machine_s pvfs2_mirror_work_sm = {
	.name = "pvfs2_mirror_work_sm",
	.first_state = &ST_initialize_structures
};

static struct PINT_state_s ST_initialize_structures = {
	 .state_name = "initialize_structures" ,
	 .parent_machine = &pvfs2_mirror_work_sm ,
	 .flag = SM_RUN ,
...
static struct PINT_tran_tbl_s ST_initialize_structures_trtbl[] = {
	{ .return_value = NO_DATA_TO_COPY ,
	 .next_state = &ST_cleanup_mirror_work },
	{ .return_value = 0 ,
	 .next_state = &ST_setup_write_request },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_mirror_work }
};

static struct PINT_state_s ST_setup_write_request = {
	 .state_name = "setup_write_request" ,
	 .parent_machine = &pvfs2_mirror_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = setup_write_request ,
	 .pjtbl = NULL ,
	 .trtbl = ST_setup_write_request_trtbl 
};

static struct PINT_tran_tbl_s ST_setup_write_request_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_call_msgpairarray },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_mirror_work }
};
...
static struct PINT_tran_tbl_s ST_cleanup_msgpairarray_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_post_ack_and_flow },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_mirror_work }
};

static struct PINT_state_s ST_post_ack_and_flow = {
	 .state_name = "post_ack_and_flow" ,
	 .parent_machine = &pvfs2_mirror_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = post_ack_and_flow ,
	 .pjtbl = NULL ,
	 .trtbl = ST_post_ack_and_flow_trtbl 
};

static struct PINT_tran_tbl_s ST_post_ack_and_flow_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_check_comm },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_mirror_work }
};

static struct PINT_state_s ST_check_comm = {
	 .state_name = "check_comm" ,
	 .parent_machine = &pvfs2_mirror_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = check_comm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_comm_trtbl 
};

static struct PINT_tran_tbl_s ST_check_comm_trtbl[] = {
	{ .return_value = COMM_DONE ,
	 .next_state = &ST_check_results },
	{ .return_value = -1 ,
	 .next_state = &ST_check_comm }
};

static struct PINT_state_s ST_check_results = {
	 .state_name = "check_results" ,
	 .parent_machine = &pvfs2_mirror_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = check_results ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_results_trtbl 
};
...
static struct PINT_state_s ST_cleanup_mirror_work = {
	 .state_name = "cleanup_mirror_work" ,
	 .parent_machine = &pvfs2_mirror_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = cleanup_mirror_work ,
	 .pjtbl = NULL ,
	 .trtbl = ST_cleanup_mirror_work_trtbl 
};
