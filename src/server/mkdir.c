...
static PINT_sm_action mkdir_dirdata_dspace_setattr(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_setattr_on_local_dirdata_dspace;
static struct PINT_pjmp_tbl_s ST_setattr_on_local_dirdata_dspace_pjtbl[];
static struct PINT_tran_tbl_s ST_setattr_on_local_dirdata_dspace_trtbl[];

static PINT_sm_action mkdir_get_remote_dirdata_handles(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_get_remote_dirdata_handles;
static struct PINT_pjmp_tbl_s ST_get_remote_dirdata_handles_pjtbl[];
static struct PINT_tran_tbl_s ST_get_remote_dirdata_handles_trtbl[];
...
static struct PINT_state_s ST_setattr_on_directory_keyval;
static struct PINT_pjmp_tbl_s ST_setattr_on_directory_keyval_pjtbl[];
static struct PINT_tran_tbl_s ST_setattr_on_directory_keyval_trtbl[];

static PINT_sm_action mkdir_dirdata_keyval_setattr(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_setattr_on_dirdata_keyval;
static struct PINT_pjmp_tbl_s ST_setattr_on_dirdata_keyval_pjtbl[];
static struct PINT_tran_tbl_s ST_setattr_on_dirdata_keyval_trtbl[];
...
static struct PINT_state_s ST_create = {
	 ...
	 .flag = SM_RUN ,
	 .action.func = mkdir_directory_dspace_create ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_set_attrib = {
	 ...
	 .parent_machine = &pvfs2_mkdir_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_directory_dspace_setattr ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_create_dist_dir_struct = {
	 ...
	 .parent_machine = &pvfs2_mkdir_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_create_dist_dir_struct ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_create_local_dirdata_dspace = {
	 ...
	 .parent_machine = &pvfs2_mkdir_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_dirdata_dspace_create ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_create_local_dirdata_dspace_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_setattr_on_local_dirdata_dspace },
	{ .return_value = -1 ,
	 .next_state = &ST_err_msg }
};

static struct PINT_state_s ST_setattr_on_local_dirdata_dspace = {
	 .state_name = "setattr_on_local_dirdata_dspace" ,
	 .parent_machine = &pvfs2_mkdir_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_dirdata_dspace_setattr ,
	 .pjtbl = NULL ,
	 .trtbl = ST_setattr_on_local_dirdata_dspace_trtbl 
};

static struct PINT_tran_tbl_s ST_setattr_on_local_dirdata_dspace_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_get_remote_dirdata_handles },
	{ .return_value = -1 ,
	 .next_state = &ST_err_msg }
};

static struct PINT_state_s ST_get_remote_dirdata_handles = {
	 .state_name = "get_remote_dirdata_handles" ,
	 .parent_machine = &pvfs2_mkdir_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_get_remote_dirdata_handles ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_remote_dirdata_handles_trtbl 
};

static struct PINT_tran_tbl_s ST_get_remote_dirdata_handles_trtbl[] = {
	{ .return_value = SKIP ,
	 .next_state = &ST_setattr_on_directory_keyval },
	{ .return_value = 0 ,
...
static struct PINT_state_s ST_fill_handles_to_dist_dir_struct = {
	 ...
	 .parent_machine = &pvfs2_mkdir_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_fill_handles_to_dist_dir_struct ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_remote_dirdata_attr_and_keyval_setup_msgpair = {
	 ...
	 .parent_machine = &pvfs2_mkdir_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_remote_dirdata_attr_and_keyval_setup_msgpair ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_setattr_on_directory_keyval = {
	 .state_name = "setattr_on_directory_keyval" ,
	 .parent_machine = &pvfs2_mkdir_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_directory_keyval_setattr ,
	 .pjtbl = NULL ,
	 .trtbl = ST_setattr_on_directory_keyval_trtbl 
};

static struct PINT_tran_tbl_s ST_setattr_on_directory_keyval_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_setattr_on_dirdata_keyval },
	{ .return_value = -1 ,
	 .next_state = &ST_err_msg }
};

static struct PINT_state_s ST_setattr_on_dirdata_keyval = {
	 .state_name = "setattr_on_dirdata_keyval" ,
	 .parent_machine = &pvfs2_mkdir_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = mkdir_dirdata_keyval_setattr ,
	 .pjtbl = NULL ,
	 .trtbl = ST_setattr_on_dirdata_keyval_trtbl 
};
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    /* save the handle generated from job_trove_dspace_create into the response structure 
    ...
    ret = job_trove_dspace_setattr(
        s_op->u.mkdir.fs_id, ds_attr->handle,
        ds_attr, 
        TROVE_SYNC,
