...
static struct PINT_state_s ST_read_mirrored_copies_count_if_required;
static struct PINT_pjmp_tbl_s ST_read_mirrored_copies_count_if_required_pjtbl[];
static struct PINT_tran_tbl_s ST_read_mirrored_copies_count_if_required_trtbl[];

static PINT_sm_action getattr_read_mirrored_handles_if_required(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_read_mirrored_handles_if_required;
static struct PINT_pjmp_tbl_s ST_read_mirrored_handles_if_required_pjtbl[];
static struct PINT_tran_tbl_s ST_read_mirrored_handles_if_required_trtbl[];

static PINT_sm_action getattr_mirrored_handles_safety_check(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_mirrored_handles_safety_check;
static struct PINT_pjmp_tbl_s ST_mirrored_handles_safety_check_pjtbl[];
static struct PINT_tran_tbl_s ST_mirrored_handles_safety_check_trtbl[];
...
static struct PINT_state_s ST_check_if_capability_required;
static struct PINT_pjmp_tbl_s ST_check_if_capability_required_pjtbl[];
static struct PINT_tran_tbl_s ST_check_if_capability_required_trtbl[];

static PINT_sm_action getattr_read_acl(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_read_acl;
static struct PINT_pjmp_tbl_s ST_read_acl_pjtbl[];
static struct PINT_tran_tbl_s ST_read_acl_trtbl[];

static PINT_sm_action getattr_create_capability(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_create_capability;
static struct PINT_pjmp_tbl_s ST_create_capability_pjtbl[];
static struct PINT_tran_tbl_s ST_create_capability_trtbl[];
...
static struct PINT_tran_tbl_s ST_verify_attribs_trtbl[] = {
	...
	{ .return_value = -1 ,
	 .next_state = &ST_check_if_capability_required }
};
...
static struct PINT_tran_tbl_s ST_datafile_handles_safety_check_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_read_mirrored_copies_count_if_required },
	{ .return_value = -1 ,
	 .next_state = &ST_check_if_capability_required }
};

static struct PINT_state_s ST_read_mirrored_copies_count_if_required = {
	 .state_name = "read_mirrored_copies_count_if_required" ,
	 .parent_machine = &pvfs2_get_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_read_mirrored_copies_count_if_required ,
	 .pjtbl = NULL ,
	 .trtbl = ST_read_mirrored_copies_count_if_required_trtbl 
};

static struct PINT_tran_tbl_s ST_read_mirrored_copies_count_if_required_trtbl[] = {
	{ .return_value = SKIP_NEXT_STATE ,
	 .next_state = &ST_read_metafile_distribution_if_required },
	{ .return_value = -1 ,
	 .next_state = &ST_read_mirrored_handles_if_required }
};

static struct PINT_state_s ST_read_mirrored_handles_if_required = {
	 .state_name = "read_mirrored_handles_if_required" ,
	 .parent_machine = &pvfs2_get_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_read_mirrored_handles_if_required ,
	 .pjtbl = NULL ,
	 .trtbl = ST_read_mirrored_handles_if_required_trtbl 
};
...
static struct PINT_tran_tbl_s ST_read_mirrored_handles_if_required_trtbl[] = {
	{ .return_value = SKIP_NEXT_STATE ,
	 .next_state = &ST_read_metafile_distribution_if_required },
	{ .return_value = -1 ,
	 .next_state = &ST_mirrored_handles_safety_check }
};

static struct PINT_state_s ST_mirrored_handles_safety_check = {
	 .state_name = "mirrored_handles_safety_check" ,
	 .parent_machine = &pvfs2_get_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_mirrored_handles_safety_check ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mirrored_handles_safety_check_trtbl 
};
...
static struct PINT_state_s ST_get_dist_dir_attr = {
	 ...
	 .parent_machine = &pvfs2_get_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_get_dist_dir_attr ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_get_bitmap_and_dirdata_handles = {
	 ...
	 .parent_machine = &pvfs2_get_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_get_bitmap_and_dirdata_handles ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_check_if_capability_required = {
	 .state_name = "check_if_capability_required" ,
	 .parent_machine = &pvfs2_get_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_check_if_capability_required ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_if_capability_required_trtbl 
};

static struct PINT_tran_tbl_s ST_check_if_capability_required_trtbl[] = {
	{ .return_value = STATE_CAPABILITY ,
	 .next_state = &ST_read_acl },
	{ .return_value = -1 ,
	 .next_state = &ST_setup_resp }
};
...
static struct PINT_state_s ST_read_acl = {
	 ...
	 .parent_machine = &pvfs2_get_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_read_acl ,
	 .pjtbl = NULL ,
	 .trtbl = ST_read_acl_trtbl 
};

static struct PINT_tran_tbl_s ST_read_acl_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_create_capability }
};

static struct PINT_state_s ST_create_capability = {
	 .state_name = "create_capability" ,
	 .parent_machine = &pvfs2_get_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_create_capability ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_capability_trtbl 
};
...
struct PINT_state_machine_s pvfs2_get_attr_with_prelude_sm = {
	.name = "pvfs2_get_attr_with_prelude_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_get_attr_with_prelude_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_with_prelude_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};
