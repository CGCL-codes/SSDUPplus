...
static PINT_sm_action initialize_structures(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_initialize_structures;
static struct PINT_pjmp_tbl_s ST_initialize_structures_pjtbl[];
static struct PINT_tran_tbl_s ST_initialize_structures_trtbl[];

static PINT_sm_action obtain_source_info(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_obtain_source_info;
static struct PINT_pjmp_tbl_s ST_obtain_source_info_pjtbl[];
static struct PINT_tran_tbl_s ST_obtain_source_info_trtbl[];

static PINT_sm_action inspect_source_info(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_inspect_source_info;
static struct PINT_pjmp_tbl_s ST_inspect_source_info_pjtbl[];
static struct PINT_tran_tbl_s ST_inspect_source_info_trtbl[];

static PINT_sm_action create_local_datahandles(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_create_local_datahandles;
static struct PINT_pjmp_tbl_s ST_create_local_datahandles_pjtbl[];
static struct PINT_tran_tbl_s ST_create_local_datahandles_trtbl[];

static PINT_sm_action obtain_local_handle_sizes(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_obtain_local_handle_sizes;
static struct PINT_pjmp_tbl_s ST_obtain_local_handle_sizes_pjtbl[];
static struct PINT_tran_tbl_s ST_obtain_local_handle_sizes_trtbl[];

static PINT_sm_action inspect_local_handle_sizes(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_inspect_local_handle_sizes;
static struct PINT_pjmp_tbl_s ST_inspect_local_handle_sizes_pjtbl[];
static struct PINT_tran_tbl_s ST_inspect_local_handle_sizes_trtbl[];

static PINT_sm_action create_remote_datahandles(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_create_remote_datahandles;
static struct PINT_pjmp_tbl_s ST_create_remote_datahandles_pjtbl[];
static struct PINT_tran_tbl_s ST_create_remote_datahandles_trtbl[];

static PINT_sm_action setup_datahandle_copies(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_setup_datahandle_copies;
static struct PINT_pjmp_tbl_s ST_setup_datahandle_copies_pjtbl[];
static struct PINT_tran_tbl_s ST_setup_datahandle_copies_trtbl[];

static PINT_sm_action copy_data(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_copy_data;
static struct PINT_pjmp_tbl_s ST_copy_data_pjtbl[];
static struct PINT_tran_tbl_s ST_copy_data_trtbl[];

static PINT_sm_action check_copy_results(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_check_copy_results;
static struct PINT_pjmp_tbl_s ST_check_copy_results_pjtbl[];
static struct PINT_tran_tbl_s ST_check_copy_results_trtbl[];

static PINT_sm_action check_for_retries(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_check_for_retries;
static struct PINT_pjmp_tbl_s ST_check_for_retries_pjtbl[];
static struct PINT_tran_tbl_s ST_check_for_retries_trtbl[];

static PINT_sm_action store_mirror_info(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_store_mirror_info;
static struct PINT_pjmp_tbl_s ST_store_mirror_info_pjtbl[];
static struct PINT_tran_tbl_s ST_store_mirror_info_trtbl[];

static PINT_sm_action check_store_job(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_check_store_job;
static struct PINT_pjmp_tbl_s ST_check_store_job_pjtbl[];
static struct PINT_tran_tbl_s ST_check_store_job_trtbl[];

static PINT_sm_action replace_remote_datahandle_objects(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_replace_remote_datahandle_objects;
static struct PINT_pjmp_tbl_s ST_replace_remote_datahandle_objects_pjtbl[];
static struct PINT_tran_tbl_s ST_replace_remote_datahandle_objects_trtbl[];

static PINT_sm_action remove_local_datahandle_objects(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remove_local_datahandle_objects;
static struct PINT_pjmp_tbl_s ST_remove_local_datahandle_objects_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_local_datahandle_objects_trtbl[];
...
struct PINT_state_machine_s pvfs2_create_immutable_copies_sm = {
	.name = "pvfs2_create_immutable_copies_sm",
	.first_state = &ST_initialize_structures
};

static struct PINT_state_s ST_initialize_structures = {
	 .state_name = "initialize_structures" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = initialize_structures ,
	 .pjtbl = NULL ,
	 .trtbl = ST_initialize_structures_trtbl 
};

static struct PINT_tran_tbl_s ST_initialize_structures_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_obtain_source_info },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_obtain_source_info = {
	 .state_name = "obtain_source_info" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = obtain_source_info ,
	 .pjtbl = NULL ,
	 .trtbl = ST_obtain_source_info_trtbl 
};

static struct PINT_tran_tbl_s ST_obtain_source_info_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_inspect_source_info },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_inspect_source_info = {
	 .state_name = "inspect_source_info" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = inspect_source_info ,
	 .pjtbl = NULL ,
	 .trtbl = ST_inspect_source_info_trtbl 
};

static struct PINT_tran_tbl_s ST_inspect_source_info_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_create_local_datahandles },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_create_local_datahandles = {
	 .state_name = "create_local_datahandles" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = create_local_datahandles ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_local_datahandles_trtbl 
};

static struct PINT_tran_tbl_s ST_create_local_datahandles_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_obtain_local_handle_sizes },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_obtain_local_handle_sizes = {
	 .state_name = "obtain_local_handle_sizes" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = obtain_local_handle_sizes ,
	 .pjtbl = NULL ,
	 .trtbl = ST_obtain_local_handle_sizes_trtbl 
};

static struct PINT_tran_tbl_s ST_obtain_local_handle_sizes_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_inspect_local_handle_sizes },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_inspect_local_handle_sizes = {
	 .state_name = "inspect_local_handle_sizes" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = inspect_local_handle_sizes ,
	 .pjtbl = NULL ,
	 .trtbl = ST_inspect_local_handle_sizes_trtbl 
};

static struct PINT_tran_tbl_s ST_inspect_local_handle_sizes_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_create_remote_datahandles },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_create_remote_datahandles = {
	 .state_name = "create_remote_datahandles" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = create_remote_datahandles ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_remote_datahandles_trtbl 
};

static struct PINT_tran_tbl_s ST_create_remote_datahandles_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_setup_datahandle_copies },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_local_datahandle_objects }
};

static struct PINT_state_s ST_setup_datahandle_copies = {
	 .state_name = "setup_datahandle_copies" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = setup_datahandle_copies ,
	 .pjtbl = NULL ,
	 .trtbl = ST_setup_datahandle_copies_trtbl 
};

static struct PINT_tran_tbl_s ST_setup_datahandle_copies_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_copy_data },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_local_datahandle_objects }
};

static struct PINT_state_s ST_copy_data = {
	 .state_name = "copy_data" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_PJMP ,
	 .action.func = &copy_data ,
	 .pjtbl = ST_copy_data_pjtbl ,
	 .trtbl = ST_copy_data_trtbl 
};

static struct PINT_pjmp_tbl_s ST_copy_data_pjtbl[] = {
	{ .return_value = LOCAL_SRC ,

	 .state_machine = &pvfs2_pjmp_mirror_work_sm },
	{ .return_value = REMOTE_SRC ,
...
static struct PINT_tran_tbl_s ST_copy_data_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_check_copy_results },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_check_copy_results = {
	 .state_name = "check_copy_results" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = check_copy_results ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_copy_results_trtbl 
};

static struct PINT_tran_tbl_s ST_check_copy_results_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_store_mirror_info },
	{ .return_value = -1 ,
	 .next_state = &ST_check_for_retries }
};

static struct PINT_state_s ST_check_for_retries = {
	 .state_name = "check_for_retries" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = check_for_retries ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_for_retries_trtbl 
};
...
static struct PINT_state_s ST_store_mirror_info = {
	 .state_name = "store_mirror_info" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = store_mirror_info ,
	 .pjtbl = NULL ,
	 .trtbl = ST_store_mirror_info_trtbl 
};

static struct PINT_tran_tbl_s ST_store_mirror_info_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_check_store_job }
};

static struct PINT_state_s ST_check_store_job = {
	 .state_name = "check_store_job" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = check_store_job ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_store_job_trtbl 
};
...
static struct PINT_state_s ST_replace_remote_datahandle_objects = {
	 .state_name = "replace_remote_datahandle_objects" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = replace_remote_datahandle_objects ,
	 .pjtbl = NULL ,
	 .trtbl = ST_replace_remote_datahandle_objects_trtbl 
};
...
static struct PINT_tran_tbl_s ST_replace_remote_datahandle_objects_trtbl[] = {
	{ .return_value = REPLACE_DONE ,
	 .next_state = &ST_remove_local_datahandle_objects },
	{ .return_value = -1 ,
	 .next_state = &ST_replace_remote_datahandle_objects }
};

static struct PINT_state_s ST_remove_local_datahandle_objects = {
	 .state_name = "remove_local_datahandle_objects" ,
	 .parent_machine = &pvfs2_create_immutable_copies_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_local_datahandle_objects ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_local_datahandle_objects_trtbl 
};
...
#ifndef WIN32
# 197 "src/server/create-immutable-copies.sm"
#endif
                                               ...
                                               job_status_s *js_p)
{
   ...
   /* nlmills: XXX: this is technically incorrect. see memset(3) */
   /* nlmills: TODO: set the values in a loop */
...
{   
   ...
   /* nlmills: TODO: replace with real capability */
...
static int perm_copies(PINT_server_op *s_op)
{
    int ret;

    /* nlmills: TODO: add real security checks */
    ret = 0;
