...
static struct PINT_state_s ST_getattr_do_work;
static struct PINT_pjmp_tbl_s ST_getattr_do_work_pjtbl[];
static struct PINT_tran_tbl_s ST_getattr_do_work_trtbl[];

static PINT_sm_action getattr_interpret(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_getattr_interpret;
static struct PINT_pjmp_tbl_s ST_getattr_interpret_pjtbl[];
static struct PINT_tran_tbl_s ST_getattr_interpret_trtbl[];

static PINT_sm_action get_keyvals(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_get_keyvals;
static struct PINT_pjmp_tbl_s ST_get_keyvals_pjtbl[];
static struct PINT_tran_tbl_s ST_get_keyvals_trtbl[];

static PINT_sm_action inspect_keyvals(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_inspect_keyvals;
static struct PINT_pjmp_tbl_s ST_inspect_keyvals_pjtbl[];
static struct PINT_tran_tbl_s ST_inspect_keyvals_trtbl[];

static PINT_sm_action get_handles(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_get_handles;
static struct PINT_pjmp_tbl_s ST_get_handles_pjtbl[];
static struct PINT_tran_tbl_s ST_get_handles_trtbl[];

static PINT_sm_action set_handles_on_object(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_set_handles_on_object;
static struct PINT_pjmp_tbl_s ST_set_handles_on_object_pjtbl[];
static struct PINT_tran_tbl_s ST_set_handles_on_object_trtbl[];

static PINT_sm_action update_dfile_count(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_update_dfile_count;
static struct PINT_pjmp_tbl_s ST_update_dfile_count_pjtbl[];
static struct PINT_tran_tbl_s ST_update_dfile_count_trtbl[];

static PINT_sm_action remove_layout(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remove_layout;
static struct PINT_pjmp_tbl_s ST_remove_layout_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_layout_trtbl[];

static PINT_sm_action get_capability_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_get_capability_setup;
static struct PINT_pjmp_tbl_s ST_get_capability_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_get_capability_setup_trtbl[];
static struct PINT_state_s ST_get_capability;
static struct PINT_pjmp_tbl_s ST_get_capability_pjtbl[];
static struct PINT_tran_tbl_s ST_get_capability_trtbl[];

static PINT_sm_action get_capability_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_get_capability_cleanup;
static struct PINT_pjmp_tbl_s ST_get_capability_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_get_capability_cleanup_trtbl[];
...
struct PINT_state_machine_s pvfs2_unstuff_sm = {
	.name = "pvfs2_unstuff_sm",
	.first_state = &ST_prelude
};

static struct PINT_state_s ST_prelude = {
	 .state_name = "prelude" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_tran_tbl_s ST_getattr_setup_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_getattr_do_work },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_getattr_do_work = {
	 .state_name = "getattr_do_work" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_get_attr_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_getattr_do_work_trtbl 
};

static struct PINT_tran_tbl_s ST_getattr_do_work_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_getattr_interpret }
};

static struct PINT_state_s ST_getattr_interpret = {
	 .state_name = "getattr_interpret" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_RUN ,
	 .action.func = getattr_interpret ,
	 .pjtbl = NULL ,
	 .trtbl = ST_getattr_interpret_trtbl 
};

static struct PINT_tran_tbl_s ST_getattr_interpret_trtbl[] = {
	{ .return_value = STATE_UNSTUFF ,
	 .next_state = &ST_get_keyvals },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_get_keyvals = {
	 .state_name = "get_keyvals" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_RUN ,
	 .action.func = get_keyvals ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_keyvals_trtbl 
};

static struct PINT_tran_tbl_s ST_get_keyvals_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_inspect_keyvals },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_inspect_keyvals = {
	 .state_name = "inspect_keyvals" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_RUN ,
	 .action.func = inspect_keyvals ,
	 .pjtbl = NULL ,
	 .trtbl = ST_inspect_keyvals_trtbl 
};

static struct PINT_tran_tbl_s ST_inspect_keyvals_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_get_handles },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_get_handles = {
	 .state_name = "get_handles" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_RUN ,
	 .action.func = get_handles ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_handles_trtbl 
};

static struct PINT_tran_tbl_s ST_get_handles_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_set_handles_on_object }
};

static struct PINT_state_s ST_set_handles_on_object = {
	 .state_name = "set_handles_on_object" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_RUN ,
	 .action.func = set_handles_on_object ,
	 .pjtbl = NULL ,
	 .trtbl = ST_set_handles_on_object_trtbl 
};

static struct PINT_tran_tbl_s ST_set_handles_on_object_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_update_dfile_count },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_update_dfile_count = {
	 .state_name = "update_dfile_count" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_RUN ,
	 .action.func = update_dfile_count ,
	 .pjtbl = NULL ,
	 .trtbl = ST_update_dfile_count_trtbl 
};

static struct PINT_tran_tbl_s ST_update_dfile_count_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_remove_layout },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_remove_layout = {
	 .state_name = "remove_layout" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_layout ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_layout_trtbl 
};

static struct PINT_tran_tbl_s ST_remove_layout_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_get_capability_setup },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_get_capability_setup = {
	 .state_name = "get_capability_setup" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_RUN ,
	 .action.func = get_capability_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_capability_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_get_capability_setup_trtbl[] = {
	{ .return_value = STATE_CAPABILITY ,
	 .next_state = &ST_get_capability },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_get_capability = {
	 .state_name = "get_capability" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_get_attr_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_capability_trtbl 
};

static struct PINT_tran_tbl_s ST_get_capability_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_get_capability_cleanup }
};

static struct PINT_state_s ST_get_capability_cleanup = {
	 .state_name = "get_capability_cleanup" ,
	 .parent_machine = &pvfs2_unstuff_sm ,
	 .flag = SM_RUN ,
	 .action.func = get_capability_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_capability_cleanup_trtbl 
};
