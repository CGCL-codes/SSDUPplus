...
static struct PINT_state_s ST_req_sched;
static struct PINT_pjmp_tbl_s ST_req_sched_pjtbl[];
static struct PINT_tran_tbl_s ST_req_sched_trtbl[];

static PINT_sm_action prelude_getattr_if_needed(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_getattr_if_needed;
static struct PINT_pjmp_tbl_s ST_getattr_if_needed_pjtbl[];
static struct PINT_tran_tbl_s ST_getattr_if_needed_trtbl[];

static PINT_sm_action prelude_validate(
	struct PINT_smcb *smcb, job_status_s *js_p);
...
struct PINT_state_machine_s pvfs2_prelude_work_sm = {
	.name = "pvfs2_prelude_work_sm",
	.first_state = &ST_req_sched
};

static struct PINT_state_s ST_req_sched = {
	 .state_name = "req_sched" ,
	 .parent_machine = &pvfs2_prelude_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = prelude_req_sched ,
	 .pjtbl = NULL ,
	 .trtbl = ST_req_sched_trtbl 
};

static struct PINT_tran_tbl_s ST_req_sched_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_getattr_if_needed },
	{ .return_value = -1 ,
	 .flag = SM_RETURN }
};

static struct PINT_state_s ST_getattr_if_needed = {
	 .state_name = "getattr_if_needed" ,
	 .parent_machine = &pvfs2_prelude_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = prelude_getattr_if_needed ,
	 .pjtbl = NULL ,
	 .trtbl = ST_getattr_if_needed_trtbl 
};
...
static struct PINT_state_s ST_prelude_work;
static struct PINT_pjmp_tbl_s ST_prelude_work_pjtbl[];
static struct PINT_tran_tbl_s ST_prelude_work_trtbl[];

struct PINT_state_machine_s pvfs2_prelude_sm = {
	.name = "pvfs2_prelude_sm",
	.first_state = &ST_setup
};

static struct PINT_state_s ST_setup = {
	 .state_name = "setup" ,
	 .parent_machine = &pvfs2_prelude_sm ,
	 .flag = SM_RUN ,
	 .action.func = prelude_setup ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_setup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_prelude_work }
};

static struct PINT_state_s ST_prelude_work = {
	 .state_name = "prelude_work" ,
	 .parent_machine = &pvfs2_prelude_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_prelude_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_prelude_work_trtbl 
};
