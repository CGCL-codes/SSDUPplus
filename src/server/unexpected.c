...
static struct PINT_state_s ST_post_unexpected;
static struct PINT_pjmp_tbl_s ST_post_unexpected_pjtbl[];
static struct PINT_tran_tbl_s ST_post_unexpected_trtbl[];

static PINT_sm_action unexpected_map(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_map_request;
static struct PINT_pjmp_tbl_s ST_map_request_pjtbl[];
static struct PINT_tran_tbl_s ST_map_request_trtbl[];

struct PINT_state_machine_s pvfs2_unexpected_sm = {
	.name = "pvfs2_unexpected_sm",
	.first_state = &ST_post_unexpected
};

static struct PINT_state_s ST_post_unexpected = {
	 .state_name = "post_unexpected" ,
	 .parent_machine = &pvfs2_unexpected_sm ,
	 .flag = SM_RUN ,
	 .action.func = unexpected_post ,
	 .pjtbl = NULL ,
	 .trtbl = ST_post_unexpected_trtbl 
};

static struct PINT_tran_tbl_s ST_post_unexpected_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_map_request }
};

static struct PINT_state_s ST_map_request = {
	 .state_name = "map_request" ,
	 .parent_machine = &pvfs2_unexpected_sm ,
	 .flag = SM_RUN ,
	 .action.func = unexpected_map ,
	 .pjtbl = NULL ,
	 .trtbl = ST_map_request_trtbl 
};
