...
static PINT_sm_action chdirent_get_dirdata_attr(
...
static struct PINT_state_s ST_get_dirdata_attr = {
	 ...
	 .parent_machine = &pvfs2_chdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = chdirent_get_dirdata_attr ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_get_dist_dir_attr = {
	 ...
	 .parent_machine = &pvfs2_chdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = chdirent_get_dist_dir_attr ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_get_bitmap = {
	 ...
	 .parent_machine = &pvfs2_chdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = chdirent_get_bitmap ,
	 .pjtbl = NULL ,
...
{       
    ...
    int ret = -PVFS_EINVAL;
    job_id_t tmp_id;
    memset(&(s_op->u.chdirent.dirdata_ds_attr), 0, sizeof(PVFS_ds_attributes));
    ...
    ret = job_trove_dspace_getattr(
        s_op->target_fs_id, s_op->req->u.chdirent.handle, smcb,
        &(s_op->u.chdirent.dirdata_ds_attr),
...
{       
    ...
    */
    PVFS_ds_attr_to_object_attr(&s_op->u.chdirent.dirdata_ds_attr,
                                &s_op->u.chdirent.dirdata_attr);
    s_op->u.chdirent.dirdata_attr.mask = PVFS_ATTR_COMMON_ALL;
    ...
    gossip_debug(GOSSIP_SERVER_DEBUG,
                 ...
                 s_op->req->u.chdirent.fs_id, llu(s_op->req->u.chdirent.handle
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    gossip_debug(GOSSIP_SERVER_DEBUG,
          "chdirent: encrypt dirent %s into hash value %llu.\n",
    ...
    dirdata_server_index =
        PINT_find_dist_dir_bucket(dirdata_hash,
            ...
            attr_p->dist_dir_bitmap);
    gossip_debug(GOSSIP_SERVER_DEBUG,
          "chdirent: selecting bucket No.%d from dist_dir_bitmap.\n",
            dirdata_server_index);
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    dspace_attr = &s_op->u.chdirent.dirdata_attr;
    ...
    ds_attr = &(s_op->u.chdirent.dirdata_ds_attr);
