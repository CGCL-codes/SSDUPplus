...
static PINT_sm_action seteattr_get_metahint_flag(
	struct PINT_smcb *smcb, job_status_s *js_p);
...
static PINT_sm_action seteattr_set_metahint_flag(
	struct PINT_smcb *smcb, job_status_s *js_p);
...
static struct PINT_state_s ST_check_mirror_mode = {
	 ...
	 .parent_machine = &pvfs2_set_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = seteattr_get_metahint_flag ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_update_flag = {
	 ...
	 .parent_machine = &pvfs2_set_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = seteattr_set_metahint_flag ,
	 .pjtbl = NULL ,
