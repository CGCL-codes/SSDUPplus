...
static struct PINT_state_s ST_remove_dirdata_init;
static struct PINT_pjmp_tbl_s ST_remove_dirdata_init_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_dirdata_init_trtbl[];
...
static struct PINT_state_s ST_get_dirdata_bitmap_and_handles;
static struct PINT_pjmp_tbl_s ST_get_dirdata_bitmap_and_handles_pjtbl[];
static struct PINT_tran_tbl_s ST_get_dirdata_bitmap_and_handles_trtbl[];

static PINT_sm_action remove_get_dirent_count_setup_tree_getattr(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_get_dirent_count_setup_tree_getattr;
static struct PINT_pjmp_tbl_s ST_get_dirent_count_setup_tree_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_get_dirent_count_setup_tree_getattr_trtbl[];
static struct PINT_state_s ST_get_dirent_count_call_tree_getattr;
static struct PINT_pjmp_tbl_s ST_get_dirent_count_call_tree_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_get_dirent_count_call_tree_getattr_trtbl[];

static PINT_sm_action remove_dirdata_handles_setup_tree_remove(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remove_dirdata_handles_setup_tree_remove;
static struct PINT_pjmp_tbl_s ST_remove_dirdata_handles_setup_tree_remove_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_dirdata_handles_setup_tree_remove_trtbl[];
static struct PINT_state_s ST_remove_dirdata_handles_call_tree_remove;
static struct PINT_pjmp_tbl_s ST_remove_dirdata_handles_call_tree_remove_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_dirdata_handles_call_tree_remove_trtbl[];

static PINT_sm_action remove_dirdata_handles_check_remove_success(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remove_dirdata_handles_check_remove_success;
static struct PINT_pjmp_tbl_s ST_remove_dirdata_handles_check_remove_success_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_dirdata_handles_check_remove_success_trtbl[];

static PINT_sm_action remove_rebuild_dirdata_handle_local(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rebuild_dirdata_handle_local;
static struct PINT_pjmp_tbl_s ST_rebuild_dirdata_handle_local_pjtbl[];
static struct PINT_tran_tbl_s ST_rebuild_dirdata_handle_local_trtbl[];

static PINT_sm_action remove_rebuild_dirdata_handle_remote(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rebuild_dirdata_handle_remote;
static struct PINT_pjmp_tbl_s ST_rebuild_dirdata_handle_remote_pjtbl[];
static struct PINT_tran_tbl_s ST_rebuild_dirdata_handle_remote_trtbl[];

static PINT_sm_action remove_rebuild_remote_dirdata_keyval_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remote_dirdata_keyval_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_remote_dirdata_keyval_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_remote_dirdata_keyval_setup_msgpair_trtbl[];

static PINT_sm_action remove_rebuild_done(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_rebuild_done;
static struct PINT_pjmp_tbl_s ST_rebuild_done_pjtbl[];
static struct PINT_tran_tbl_s ST_rebuild_done_trtbl[];
static struct PINT_state_s ST_remote_dirdata_keyval_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_remote_dirdata_keyval_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_remote_dirdata_keyval_xfer_msgpair_trtbl[];

static PINT_sm_action remove_rebuild_write_dirdata_keyval(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_write_dirdata_keyval;
static struct PINT_pjmp_tbl_s ST_write_dirdata_keyval_pjtbl[];
static struct PINT_tran_tbl_s ST_write_dirdata_keyval_trtbl[];

static PINT_sm_action remove_remove_dirdata_handles_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remove_dirdata_handles_cleanup;
static struct PINT_pjmp_tbl_s ST_remove_dirdata_handles_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_dirdata_handles_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_remove_dirdata_handles_work_sm = {
	.name = "pvfs2_remove_dirdata_handles_work_sm",
	.first_state = &ST_remove_dirdata_init
};

static struct PINT_state_s ST_remove_dirdata_init = {
	 .state_name = "remove_dirdata_init" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_dirdata_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_dirdata_init_trtbl 
};
...
static struct PINT_state_s ST_get_dist_dir_attr = {
	 ...
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_get_dist_dir_attr ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_get_dist_dir_attr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_get_dirdata_bitmap_and_handles },
	{ .return_value = -1 ,
	 .flag = SM_RETURN }
};

static struct PINT_state_s ST_get_dirdata_bitmap_and_handles = {
	 .state_name = "get_dirdata_bitmap_and_handles" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_get_dirdata_bitmap_and_handles ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_dirdata_bitmap_and_handles_trtbl 
};

static struct PINT_tran_tbl_s ST_get_dirdata_bitmap_and_handles_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_get_dirent_count_setup_tree_getattr },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_dirdata_handles_cleanup }
};

static struct PINT_state_s ST_get_dirent_count_setup_tree_getattr = {
	 .state_name = "get_dirent_count_setup_tree_getattr" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_get_dirent_count_setup_tree_getattr ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_dirent_count_setup_tree_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_get_dirent_count_setup_tree_getattr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_get_dirent_count_call_tree_getattr },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_dirdata_handles_cleanup }
};

static struct PINT_state_s ST_get_dirent_count_call_tree_getattr = {
	 .state_name = "get_dirent_count_call_tree_getattr" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_tree_getattr_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_dirent_count_call_tree_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_get_dirent_count_call_tree_getattr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_remove_dirdata_handles_setup_tree_remove },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_dirdata_handles_cleanup }
};

static struct PINT_state_s ST_remove_dirdata_handles_setup_tree_remove = {
	 .state_name = "remove_dirdata_handles_setup_tree_remove" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_dirdata_handles_setup_tree_remove ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_dirdata_handles_setup_tree_remove_trtbl 
};

static struct PINT_tran_tbl_s ST_remove_dirdata_handles_setup_tree_remove_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_remove_dirdata_handles_call_tree_remove },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_dirdata_handles_cleanup }
};

static struct PINT_state_s ST_remove_dirdata_handles_call_tree_remove = {
	 .state_name = "remove_dirdata_handles_call_tree_remove" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_tree_remove_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_dirdata_handles_call_tree_remove_trtbl 
};

static struct PINT_tran_tbl_s ST_remove_dirdata_handles_call_tree_remove_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_remove_dirdata_handles_check_remove_success },
	{ .return_value = -1 ,
	 .next_state = &ST_rebuild_dirdata_handle_local }
};

static struct PINT_state_s ST_remove_dirdata_handles_check_remove_success = {
	 .state_name = "remove_dirdata_handles_check_remove_success" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_dirdata_handles_check_remove_success ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_dirdata_handles_check_remove_success_trtbl 
};
...
static struct PINT_state_s ST_rebuild_dirdata_handle_local = {
	 .state_name = "rebuild_dirdata_handle_local" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_rebuild_dirdata_handle_local ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rebuild_dirdata_handle_local_trtbl 
};

static struct PINT_tran_tbl_s ST_rebuild_dirdata_handle_local_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_rebuild_dirdata_handle_remote },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_dirdata_handles_cleanup }
};

static struct PINT_state_s ST_rebuild_dirdata_handle_remote = {
	 .state_name = "rebuild_dirdata_handle_remote" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_rebuild_dirdata_handle_remote ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rebuild_dirdata_handle_remote_trtbl 
};

static struct PINT_tran_tbl_s ST_rebuild_dirdata_handle_remote_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_remote_dirdata_keyval_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_dirdata_handles_cleanup }
};

static struct PINT_state_s ST_remote_dirdata_keyval_setup_msgpair = {
	 .state_name = "remote_dirdata_keyval_setup_msgpair" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_rebuild_remote_dirdata_keyval_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remote_dirdata_keyval_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_remote_dirdata_keyval_setup_msgpair_trtbl[] = {
	{ .return_value = REBUILD_DONE ,
	 .next_state = &ST_rebuild_done },
	{ .return_value = 0 ,
	 .next_state = &ST_remote_dirdata_keyval_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_dirdata_handles_cleanup }
};

static struct PINT_state_s ST_rebuild_done = {
	 .state_name = "rebuild_done" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_rebuild_done ,
	 .pjtbl = NULL ,
	 .trtbl = ST_rebuild_done_trtbl 
};
...
static struct PINT_state_s ST_remote_dirdata_keyval_xfer_msgpair = {
	 .state_name = "remote_dirdata_keyval_xfer_msgpair" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remote_dirdata_keyval_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_remote_dirdata_keyval_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_write_dirdata_keyval },
	{ .return_value = -1 ,
	 .next_state = &ST_remove_dirdata_handles_cleanup }
};

static struct PINT_state_s ST_write_dirdata_keyval = {
	 .state_name = "write_dirdata_keyval" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_rebuild_write_dirdata_keyval ,
	 .pjtbl = NULL ,
	 .trtbl = ST_write_dirdata_keyval_trtbl 
};
...
static struct PINT_state_s ST_remove_dirdata_handles_cleanup = {
	 .state_name = "remove_dirdata_handles_cleanup" ,
	 .parent_machine = &pvfs2_remove_dirdata_handles_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_remove_dirdata_handles_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_dirdata_handles_cleanup_trtbl 
};
...
static struct PINT_state_s ST_remove_dirdata_handles;
static struct PINT_pjmp_tbl_s ST_remove_dirdata_handles_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_dirdata_handles_trtbl[];
...
static struct PINT_tran_tbl_s ST_check_object_type_trtbl[] = {
	...
	{ .return_value = STATE_TYPE_DIRDATA ,
...
static struct PINT_tran_tbl_s ST_verify_object_metadata_trtbl[] = {
	{ .return_value = STATE_TYPE_DIRECTORY ,
	 .next_state = &ST_remove_dirdata_handles },
	{ .return_value = 0 ,
	 .next_state = &ST_remove_dspace },
	{ .return_value = -1 ,
	 .flag = SM_RETURN }
...
static struct PINT_state_s ST_remove_dirdata_handles = {
	 .state_name = "remove_dirdata_handles" ,
	 .parent_machine = &pvfs2_remove_work_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_remove_dirdata_handles_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_dirdata_handles_trtbl 
};
...
struct PINT_state_machine_s pvfs2_remove_with_prelude_sm = {
	.name = "pvfs2_remove_with_prelude_sm",
	.first_state = &ST_prelude
};

static struct PINT_state_s ST_prelude = {
	 .state_name = "prelude" ,
	 .parent_machine = &pvfs2_remove_with_prelude_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_state_s ST_work = {
	 ...
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_remove_with_prelude_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_work_trtbl 
};
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    {
        /* This is the first point we know this is a file rm so
         * increment the counter for remove requests
         */
