...
static struct PINT_state_s ST_get_bitmap_and_dirdata_handles;
static struct PINT_pjmp_tbl_s ST_get_bitmap_and_dirdata_handles_pjtbl[];
static struct PINT_tran_tbl_s ST_get_bitmap_and_dirdata_handles_trtbl[];

static PINT_sm_action crdirent_validate(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_validate;
static struct PINT_pjmp_tbl_s ST_validate_pjtbl[];
static struct PINT_tran_tbl_s ST_validate_trtbl[];

static PINT_sm_action validation_object_type_failure(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_validation_object_type_failure;
static struct PINT_pjmp_tbl_s ST_validation_object_type_failure_pjtbl[];
static struct PINT_tran_tbl_s ST_validation_object_type_failure_trtbl[];

static PINT_sm_action validation_dirdata_mismatch(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_validation_dirdata_mismatch;
static struct PINT_pjmp_tbl_s ST_validation_dirdata_mismatch_pjtbl[];
static struct PINT_tran_tbl_s ST_validation_dirdata_mismatch_trtbl[];

static PINT_sm_action crdirent_write_directory_entry(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_write_directory_entry;
static struct PINT_pjmp_tbl_s ST_write_directory_entry_pjtbl[];
static struct PINT_tran_tbl_s ST_write_directory_entry_trtbl[];
...
static struct PINT_state_s ST_check_for_split;
static struct PINT_pjmp_tbl_s ST_check_for_split_pjtbl[];
static struct PINT_tran_tbl_s ST_check_for_split_trtbl[];

static PINT_sm_action crdirent_retrieve_dir_entries(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_retrieve_dir_entries;
static struct PINT_pjmp_tbl_s ST_retrieve_dir_entries_pjtbl[];
static struct PINT_tran_tbl_s ST_retrieve_dir_entries_trtbl[];

static PINT_sm_action crdirent_find_split_entries(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_find_split_entries;
static struct PINT_pjmp_tbl_s ST_find_split_entries_pjtbl[];
static struct PINT_tran_tbl_s ST_find_split_entries_trtbl[];
static struct PINT_state_s ST_split_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_split_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_split_xfer_msgpair_trtbl[];

static PINT_sm_action crdirent_activate_server_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_activate_server_setup;
static struct PINT_pjmp_tbl_s ST_activate_server_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_activate_server_setup_trtbl[];
static struct PINT_state_s ST_activate_server;
static struct PINT_pjmp_tbl_s ST_activate_server_pjtbl[];
static struct PINT_tran_tbl_s ST_activate_server_trtbl[];

static PINT_sm_action crdirent_deactivate_server_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_deactivate_server_setup;
static struct PINT_pjmp_tbl_s ST_deactivate_server_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_deactivate_server_setup_trtbl[];
static struct PINT_state_s ST_deactivate_server;
static struct PINT_pjmp_tbl_s ST_deactivate_server_pjtbl[];
static struct PINT_tran_tbl_s ST_deactivate_server_trtbl[];

static PINT_sm_action crdirent_update_dirdata_attrs(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_update_dirdata_attrs;
static struct PINT_pjmp_tbl_s ST_update_dirdata_attrs_pjtbl[];
static struct PINT_tran_tbl_s ST_update_dirdata_attrs_trtbl[];

static PINT_sm_action crdirent_update_metahandle_attrs(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_update_metahandle_attrs;
static struct PINT_pjmp_tbl_s ST_update_metahandle_attrs_pjtbl[];
static struct PINT_tran_tbl_s ST_update_metahandle_attrs_trtbl[];
static struct PINT_state_s ST_update_metahandle_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_update_metahandle_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_update_metahandle_xfer_msgpair_trtbl[];

static PINT_sm_action crdirent_notify_dirdata_servers_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_notify_dirdata_servers_setup;
static struct PINT_pjmp_tbl_s ST_notify_dirdata_servers_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_notify_dirdata_servers_setup_trtbl[];
static struct PINT_state_s ST_notify_dirdata_servers_xfer;
static struct PINT_pjmp_tbl_s ST_notify_dirdata_servers_xfer_pjtbl[];
static struct PINT_tran_tbl_s ST_notify_dirdata_servers_xfer_trtbl[];

static PINT_sm_action crdirent_backout_dirdata_attrs(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_backout_dirdata_attrs;
static struct PINT_pjmp_tbl_s ST_backout_dirdata_attrs_pjtbl[];
static struct PINT_tran_tbl_s ST_backout_dirdata_attrs_trtbl[];

static PINT_sm_action crdirent_remove_local_copies(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remove_local_copies;
static struct PINT_pjmp_tbl_s ST_remove_local_copies_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_local_copies_trtbl[];

static PINT_sm_action crdirent_split_cleanup_msgpairarray(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_split_cleanup_msgpairarray;
static struct PINT_pjmp_tbl_s ST_split_cleanup_msgpairarray_pjtbl[];
static struct PINT_tran_tbl_s ST_split_cleanup_msgpairarray_trtbl[];

static PINT_sm_action crdirent_split_remove_entries(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_split_remove_entries;
static struct PINT_pjmp_tbl_s ST_split_remove_entries_pjtbl[];
static struct PINT_tran_tbl_s ST_split_remove_entries_trtbl[];
static struct PINT_state_s ST_split_remove_entries_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_split_remove_entries_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_split_remove_entries_xfer_msgpair_trtbl[];

static PINT_sm_action crdirent_remove_entries_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remove_entries_cleanup;
static struct PINT_pjmp_tbl_s ST_remove_entries_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_remove_entries_cleanup_trtbl[];
...
static struct PINT_state_s ST_get_dist_dir_attr = {
	 ...
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_get_dist_dir_attr ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_get_dist_dir_attr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_get_bitmap_and_dirdata_handles },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_get_bitmap_and_dirdata_handles = {
	 .state_name = "get_bitmap_and_dirdata_handles" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_get_bitmap_and_dirdata_handles ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_bitmap_and_dirdata_handles_trtbl 
};
...
static struct PINT_state_s ST_validate = {
	 ...
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_validate ,
	 .pjtbl = NULL ,
	 .trtbl = ST_validate_trtbl 
};
...
static struct PINT_tran_tbl_s ST_validate_trtbl[] = {
	...
	{ .return_value = INVALID_DIRDATA ,
	 .next_state = &ST_validation_dirdata_mismatch },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};
...
static struct PINT_state_s ST_validation_object_type_failure = {
	 ...
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = validation_object_type_failure ,
	 .pjtbl = NULL ,
	 .trtbl = ST_validation_object_type_failure_trtbl 
};
...
static struct PINT_state_s ST_validation_dirdata_mismatch = {
	 .state_name = "validation_dirdata_mismatch" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = validation_dirdata_mismatch ,
	 .pjtbl = NULL ,
	 .trtbl = ST_validation_dirdata_mismatch_trtbl 
};
...
static struct PINT_state_s ST_write_directory_entry = {
	 ...
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_write_directory_entry ,
	 .pjtbl = NULL ,
	 .trtbl = ST_write_directory_entry_trtbl 
};
...
static struct PINT_state_s ST_check_for_req_dir_update = {
	 ...
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_check_for_req_dir_update ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_update_directory_attr = {
	 ...
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_update_directory_attr ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_get_dirent_count = {
	 ...
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_get_dirent_count ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_get_dirent_count_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_check_for_split },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_check_for_split = {
	 .state_name = "check_for_split" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_check_for_split ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_for_split_trtbl 
};

static struct PINT_tran_tbl_s ST_check_for_split_trtbl[] = {
	{ .return_value = SPLIT_REQUIRED ,
	 .next_state = &ST_retrieve_dir_entries },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_retrieve_dir_entries = {
	 .state_name = "retrieve_dir_entries" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_retrieve_dir_entries ,
	 .pjtbl = NULL ,
	 .trtbl = ST_retrieve_dir_entries_trtbl 
};

static struct PINT_tran_tbl_s ST_retrieve_dir_entries_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_find_split_entries },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_find_split_entries = {
	 .state_name = "find_split_entries" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_find_split_entries ,
	 .pjtbl = NULL ,
	 .trtbl = ST_find_split_entries_trtbl 
};

static struct PINT_tran_tbl_s ST_find_split_entries_trtbl[] = {
	{ .return_value = SPLIT_REQUIRED ,
	 .next_state = &ST_split_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_split_xfer_msgpair = {
	 .state_name = "split_xfer_msgpair" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_split_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_split_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_activate_server_setup },
	{ .return_value = -1 ,
	 .next_state = &ST_split_cleanup_msgpairarray }
};

static struct PINT_state_s ST_activate_server_setup = {
	 .state_name = "activate_server_setup" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_activate_server_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_activate_server_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_activate_server_setup_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_activate_server },
	{ .return_value = -1 ,
	 .next_state = &ST_split_remove_entries }
};

static struct PINT_state_s ST_activate_server = {
	 .state_name = "activate_server" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_activate_server_trtbl 
};

static struct PINT_tran_tbl_s ST_activate_server_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_update_dirdata_attrs },
	{ .return_value = -1 ,
	 .next_state = &ST_split_remove_entries }
};

static struct PINT_state_s ST_deactivate_server_setup = {
	 .state_name = "deactivate_server_setup" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_deactivate_server_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_deactivate_server_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_deactivate_server_setup_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_deactivate_server },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_deactivate_server = {
	 .state_name = "deactivate_server" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_deactivate_server_trtbl 
};
...
static struct PINT_state_s ST_update_dirdata_attrs = {
	 .state_name = "update_dirdata_attrs" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_update_dirdata_attrs ,
	 .pjtbl = NULL ,
	 .trtbl = ST_update_dirdata_attrs_trtbl 
};

static struct PINT_tran_tbl_s ST_update_dirdata_attrs_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_update_metahandle_attrs },
	{ .return_value = -1 ,
	 .next_state = &ST_deactivate_server_setup }
};

static struct PINT_state_s ST_update_metahandle_attrs = {
	 .state_name = "update_metahandle_attrs" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_update_metahandle_attrs ,
	 .pjtbl = NULL ,
	 .trtbl = ST_update_metahandle_attrs_trtbl 
};

static struct PINT_tran_tbl_s ST_update_metahandle_attrs_trtbl[] = {
	{ .return_value = REMOTE_METAHANDLE ,
	 .next_state = &ST_update_metahandle_xfer_msgpair },
	{ .return_value = 0 ,
	 .next_state = &ST_notify_dirdata_servers_setup },
	{ .return_value = -1 ,
	 .next_state = &ST_backout_dirdata_attrs }
};

static struct PINT_state_s ST_update_metahandle_xfer_msgpair = {
	 .state_name = "update_metahandle_xfer_msgpair" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_update_metahandle_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_notify_dirdata_servers_setup = {
	 .state_name = "notify_dirdata_servers_setup" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_notify_dirdata_servers_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_notify_dirdata_servers_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_notify_dirdata_servers_setup_trtbl[] = {
	{ .return_value = NOTIFY_DIRDATA ,
	 .next_state = &ST_notify_dirdata_servers_xfer },
	{ .return_value = 0 ,
	 .next_state = &ST_remove_local_copies },
	{ .return_value = -1 ,
	 .next_state = &ST_backout_dirdata_attrs }
};

static struct PINT_state_s ST_notify_dirdata_servers_xfer = {
	 .state_name = "notify_dirdata_servers_xfer" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_notify_dirdata_servers_xfer_trtbl 
};
...
static struct PINT_state_s ST_backout_dirdata_attrs = {
	 .state_name = "backout_dirdata_attrs" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_backout_dirdata_attrs ,
	 .pjtbl = NULL ,
	 .trtbl = ST_backout_dirdata_attrs_trtbl 
};
...
static struct PINT_state_s ST_remove_local_copies = {
	 .state_name = "remove_local_copies" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_remove_local_copies ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_local_copies_trtbl 
};
...
static struct PINT_state_s ST_split_cleanup_msgpairarray = {
	 .state_name = "split_cleanup_msgpairarray" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_split_cleanup_msgpairarray ,
	 .pjtbl = NULL ,
	 .trtbl = ST_split_cleanup_msgpairarray_trtbl 
};
...
static struct PINT_state_s ST_split_remove_entries = {
	 .state_name = "split_remove_entries" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_split_remove_entries ,
	 .pjtbl = NULL ,
	 .trtbl = ST_split_remove_entries_trtbl 
};

static struct PINT_tran_tbl_s ST_split_remove_entries_trtbl[] = {
	{ .return_value = REMOVE_ENTRIES_REQUIRED ,
	 .next_state = &ST_split_remove_entries_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_split_remove_entries_xfer_msgpair = {
	 .state_name = "split_remove_entries_xfer_msgpair" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_split_remove_entries_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_split_remove_entries_xfer_msgpair_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_remove_entries_cleanup }
};

static struct PINT_state_s ST_remove_entries_cleanup = {
	 .state_name = "remove_entries_cleanup" ,
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_remove_entries_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remove_entries_cleanup_trtbl 
};
