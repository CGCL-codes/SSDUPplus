...
static struct PINT_state_s ST_write_directory_entries;
static struct PINT_pjmp_tbl_s ST_write_directory_entries_pjtbl[];
static struct PINT_tran_tbl_s ST_write_directory_entries_trtbl[];
...
struct PINT_state_machine_s pvfs2_mgmt_split_dirent_sm = {
	.name = "pvfs2_mgmt_split_dirent_sm",
	.first_state = &ST_prelude
};

static struct PINT_state_s ST_prelude = {
	 .state_name = "prelude" ,
	 .parent_machine = &pvfs2_mgmt_split_dirent_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_tran_tbl_s ST_prelude_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_write_directory_entries },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_write_directory_entries = {
	 .state_name = "write_directory_entries" ,
	 .parent_machine = &pvfs2_mgmt_split_dirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_split_dirent_write_directory_entries ,
	 .pjtbl = NULL ,
	 .trtbl = ST_write_directory_entries_trtbl 
};
...
static struct PINT_state_s ST_update_directory_attr = {
	 ...
	 .parent_machine = &pvfs2_mgmt_split_dirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_split_dirent_update_directory_attr ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_release = {
	 ...
	 .parent_machine = &pvfs2_mgmt_split_dirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_split_dirent_release ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_mgmt_split_dirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_split_dirent_cleanup ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 68 "src/server/mgmt-split-dirent.sm"
#endif
