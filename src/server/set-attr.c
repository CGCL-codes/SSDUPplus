...
static PINT_sm_action setattr_set_dirdata_attr_init(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_set_dirdata_attr_init;
static struct PINT_pjmp_tbl_s ST_set_dirdata_attr_init_pjtbl[];
static struct PINT_tran_tbl_s ST_set_dirdata_attr_init_trtbl[];

static PINT_sm_action setattr_remote_dirdata_attr_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remote_dirdata_attr_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_remote_dirdata_attr_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_remote_dirdata_attr_setup_msgpair_trtbl[];
static struct PINT_state_s ST_remote_dirdata_attr_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_remote_dirdata_attr_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_remote_dirdata_attr_xfer_msgpair_trtbl[];

static PINT_sm_action setattr_set_dirdata_attr_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_set_dirdata_attr_cleanup;
static struct PINT_pjmp_tbl_s ST_set_dirdata_attr_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_set_dirdata_attr_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_set_dirdata_attr_work_sm = {
	.name = "pvfs2_set_dirdata_attr_work_sm",
	.first_state = &ST_set_dirdata_attr_init
};

static struct PINT_state_s ST_set_dirdata_attr_init = {
	 .state_name = "set_dirdata_attr_init" ,
	 .parent_machine = &pvfs2_set_dirdata_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_set_dirdata_attr_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_set_dirdata_attr_init_trtbl 
};

static struct PINT_tran_tbl_s ST_set_dirdata_attr_init_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_remote_dirdata_attr_setup_msgpair }
};

static struct PINT_state_s ST_remote_dirdata_attr_setup_msgpair = {
	 .state_name = "remote_dirdata_attr_setup_msgpair" ,
	 .parent_machine = &pvfs2_set_dirdata_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_remote_dirdata_attr_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remote_dirdata_attr_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_remote_dirdata_attr_setup_msgpair_trtbl[] = {
	{ .return_value = STATE_DIRECTORY ,
	 .next_state = &ST_remote_dirdata_attr_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_set_dirdata_attr_cleanup }
};

static struct PINT_state_s ST_remote_dirdata_attr_xfer_msgpair = {
	 .state_name = "remote_dirdata_attr_xfer_msgpair" ,
	 .parent_machine = &pvfs2_set_dirdata_attr_work_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remote_dirdata_attr_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_set_dirdata_attr_cleanup = {
	 .state_name = "set_dirdata_attr_cleanup" ,
	 .parent_machine = &pvfs2_set_dirdata_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_set_dirdata_attr_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_set_dirdata_attr_cleanup_trtbl 
};
...
static struct PINT_state_s ST_write_distr_dir_data_if_required;
static struct PINT_pjmp_tbl_s ST_write_distr_dir_data_if_required_pjtbl[];
static struct PINT_tran_tbl_s ST_write_distr_dir_data_if_required_trtbl[];
static struct PINT_state_s ST_set_dirdata_attrs;
static struct PINT_pjmp_tbl_s ST_set_dirdata_attrs_pjtbl[];
static struct PINT_tran_tbl_s ST_set_dirdata_attrs_trtbl[];
...
static struct PINT_state_s ST_work_cleanup;
static struct PINT_pjmp_tbl_s ST_work_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_work_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_set_attr_work_sm = {
	.name = "pvfs2_set_attr_work_sm",
	.first_state = &ST_verify_attribs
};

static struct PINT_state_s ST_verify_attribs = {
	 .state_name = "verify_attribs" ,
	 .parent_machine = &pvfs2_set_attr_work_sm ,
	 .flag = SM_RUN ,
...
static struct PINT_tran_tbl_s ST_verify_attribs_trtbl[] = {
	...
	{ .return_value = STATE_DIRDATA ,
	 .next_state = &ST_write_distr_dir_data_if_required },
	{ .return_value = STATE_DIRECTORY ,
	 .next_state = &ST_set_dirdata_attrs },
	{ .return_value = 0 ,
	 .next_state = &ST_setobj_attrib },
	{ .return_value = -1 ,
	 .next_state = &ST_work_cleanup }
};
...
static struct PINT_state_s ST_write_distr_dir_data_if_required = {
	 .state_name = "write_distr_dir_data_if_required" ,
	 .parent_machine = &pvfs2_set_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_write_distr_dir_data_if_required ,
	 .pjtbl = NULL ,
	 .trtbl = ST_write_distr_dir_data_if_required_trtbl 
};
...
static struct PINT_state_s ST_set_dirdata_attrs = {
	 .state_name = "set_dirdata_attrs" ,
	 .parent_machine = &pvfs2_set_attr_work_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_set_dirdata_attr_work_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_set_dirdata_attrs_trtbl 
};
...
static struct PINT_state_s ST_work_cleanup = {
	 .state_name = "work_cleanup" ,
	 .parent_machine = &pvfs2_set_attr_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_work_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_work_cleanup_trtbl 
};
...
struct PINT_state_machine_s pvfs2_set_attr_with_prelude_sm = {
	.name = "pvfs2_set_attr_with_prelude_sm",
	.first_state = &ST_prelude
};

static struct PINT_state_s ST_prelude = {
	 .state_name = "prelude" ,
	 .parent_machine = &pvfs2_set_attr_with_prelude_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_state_s ST_work = {
	 ...
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_set_attr_with_prelude_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_work_trtbl 
};
...
static PINT_sm_action setattr_remote_dirdata_attr_setup_msgpair(struct PINT_smcb *smcb, job_status_s *js_p)
{
    struct PINT_server_op *s_op = PINT_sm_frame(smcb, PINT_FRAME_CURRENT);
    ...
    msg_p->fs_id = s_op->req->u.setattr.fs_id;
