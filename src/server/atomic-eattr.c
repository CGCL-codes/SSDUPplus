...
static struct PINT_state_s ST_modify_eattrib;
static struct PINT_pjmp_tbl_s ST_modify_eattrib_pjtbl[];
static struct PINT_tran_tbl_s ST_modify_eattrib_trtbl[];
...
static struct PINT_state_s ST_check_mirror_mode;
static struct PINT_pjmp_tbl_s ST_check_mirror_mode_pjtbl[];
static struct PINT_tran_tbl_s ST_check_mirror_mode_trtbl[];

static PINT_sm_action atomiceattr_set_metahint_flag(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_update_flag;
static struct PINT_pjmp_tbl_s ST_update_flag_pjtbl[];
static struct PINT_tran_tbl_s ST_update_flag_trtbl[];

static PINT_sm_action check_immutable(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_check_immutable;
static struct PINT_pjmp_tbl_s ST_check_immutable_pjtbl[];
static struct PINT_tran_tbl_s ST_check_immutable_trtbl[];

static PINT_sm_action setup_create_immutable_copies(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_generate_copies;
static struct PINT_pjmp_tbl_s ST_generate_copies_pjtbl[];
static struct PINT_tran_tbl_s ST_generate_copies_trtbl[];

static PINT_sm_action inspect_imm_copies(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_inspect_imm_copies;
static struct PINT_pjmp_tbl_s ST_inspect_imm_copies_pjtbl[];
static struct PINT_tran_tbl_s ST_inspect_imm_copies_trtbl[];
...
struct PINT_state_machine_s pvfs2_atomic_eattr_sm = {
	.name = "pvfs2_atomic_eattr_sm",
	.first_state = &ST_prelude
};

static struct PINT_state_s ST_prelude = {
	 .state_name = "prelude" ,
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_state_s ST_setup_resp = {
	 ...
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = atomiceattr_setup_resp ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_read_eattrib = {
	 ...
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = atomiceattr_read_eattrib ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_check_resp = {
	 ...
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = atomiceattr_check_resp ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_check_resp_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_modify_eattrib }
};

static struct PINT_state_s ST_modify_eattrib = {
	 .state_name = "modify_eattrib" ,
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = atomiceattr_modify_eattrib ,
	 .pjtbl = NULL ,
	 .trtbl = ST_modify_eattrib_trtbl 
};
...
static struct PINT_state_s ST_verify_eattrib = {
	 ...
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = atomiceattr_verify_eattribs ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_setobj_eattrib = {
	 ...
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = atomiceattr_setobj_eattribs ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_setobj_eattrib_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_check_mirror_mode },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_check_mirror_mode = {
	 .state_name = "check_mirror_mode" ,
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = atomiceattr_get_metahint_flag ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_mirror_mode_trtbl 
};

static struct PINT_tran_tbl_s ST_check_mirror_mode_trtbl[] = {
	{ .return_value = SKIP_UPDATE ,
	 .next_state = &ST_check_immutable },
	{ .return_value = -1 ,
	 .next_state = &ST_update_flag }
};

static struct PINT_state_s ST_update_flag = {
	 .state_name = "update_flag" ,
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = atomiceattr_set_metahint_flag ,
	 .pjtbl = NULL ,
	 .trtbl = ST_update_flag_trtbl 
};
...
static struct PINT_state_s ST_check_immutable = {
	 .state_name = "check_immutable" ,
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = check_immutable ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_immutable_trtbl 
};

static struct PINT_tran_tbl_s ST_check_immutable_trtbl[] = {
	{ .return_value = PVFS2_MAKE_IMMUTABLE_COPIES ,
	 .next_state = &ST_generate_copies },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_generate_copies = {
	 .state_name = "generate_copies" ,
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_PJMP ,
	 .action.func = &setup_create_immutable_copies ,
	 .pjtbl = ST_generate_copies_pjtbl ,
	 .trtbl = ST_generate_copies_trtbl 
};

static struct PINT_pjmp_tbl_s ST_generate_copies_pjtbl[] = {
	{ .return_value = CREATE_IMM_COPIES ,

	 .state_machine = &pvfs2_pjmp_create_immutable_copies_sm }
};

static struct PINT_tran_tbl_s ST_generate_copies_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_inspect_imm_copies },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_inspect_imm_copies = {
	 .state_name = "inspect_imm_copies" ,
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = inspect_imm_copies ,
	 .pjtbl = NULL ,
	 .trtbl = ST_inspect_imm_copies_trtbl 
};
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_atomic_eattr_sm ,
	 .flag = SM_RUN ,
	 .action.func = atomiceattr_cleanup ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 143 "src/server/atomic-eattr.sm"
#endif
 ...
 * accordingly.
 */
static int atomiceattr_modify_eattrib(
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    struct PINT_server_op *s_op = PINT_sm_frame(smcb, PINT_FRAME_CURRENT);
    int i;
 ...
 */
static int atomiceattr_verify_eattribs(
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    struct PINT_server_op *s_op = PINT_sm_frame(smcb, PINT_FRAME_CURRENT);
    int i; 
 ...
 */
static int atomiceattr_setobj_eattribs(
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    struct PINT_server_op *s_op = PINT_sm_frame(smcb, PINT_FRAME_CURRENT);
    int ret = 0;
 ...
 *           
 */
static int atomiceattr_cleanup(
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    int i;
