...
static struct PINT_state_s ST_check_for_request;
static struct PINT_pjmp_tbl_s ST_check_for_request_pjtbl[];
static struct PINT_tran_tbl_s ST_check_for_request_trtbl[];

static PINT_sm_action mgmt_create_root_dir_create_dist_dir_struct(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_create_dist_dir_struct;
static struct PINT_pjmp_tbl_s ST_create_dist_dir_struct_pjtbl[];
static struct PINT_tran_tbl_s ST_create_dist_dir_struct_trtbl[];

static PINT_sm_action mgmt_create_root_dir_request_remote_dirdata_dspace(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_request_remote_dirdata_dspace;
static struct PINT_pjmp_tbl_s ST_request_remote_dirdata_dspace_pjtbl[];
static struct PINT_tran_tbl_s ST_request_remote_dirdata_dspace_trtbl[];

static PINT_sm_action mgmt_create_root_dir_retry_remote_dirdata_dspace(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_retry_remote_dirdata_dspace;
static struct PINT_pjmp_tbl_s ST_retry_remote_dirdata_dspace_pjtbl[];
static struct PINT_tran_tbl_s ST_retry_remote_dirdata_dspace_trtbl[];

static PINT_sm_action mgmt_create_root_dir_create_local_dirdata_dspace(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_create_local_dirdata_dspace;
static struct PINT_pjmp_tbl_s ST_create_local_dirdata_dspace_pjtbl[];
static struct PINT_tran_tbl_s ST_create_local_dirdata_dspace_trtbl[];

static PINT_sm_action mgmt_create_root_dir_fill_handles_to_dist_dir_struct(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_fill_handles_to_dist_dir_struct;
static struct PINT_pjmp_tbl_s ST_fill_handles_to_dist_dir_struct_pjtbl[];
static struct PINT_tran_tbl_s ST_fill_handles_to_dist_dir_struct_trtbl[];

static PINT_sm_action mgmt_create_root_dir_remote_dirdata_attr_and_keyval_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_remote_dirdata_attr_and_keyval_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_remote_dirdata_attr_and_keyval_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_remote_dirdata_attr_and_keyval_setup_msgpair_trtbl[];
static struct PINT_state_s ST_remote_dirdata_attr_and_keyval_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_remote_dirdata_attr_and_keyval_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_remote_dirdata_attr_and_keyval_xfer_msgpair_trtbl[];

static PINT_sm_action mgmt_create_root_dir_write_keyval_to_meta_handle(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_write_keyval_to_meta_handle;
static struct PINT_pjmp_tbl_s ST_write_keyval_to_meta_handle_pjtbl[];
static struct PINT_tran_tbl_s ST_write_keyval_to_meta_handle_trtbl[];

static PINT_sm_action mgmt_create_root_dir_write_keyval_to_dirdata_handle(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_write_keyval_to_dirdata_handle;
static struct PINT_pjmp_tbl_s ST_write_keyval_to_dirdata_handle_pjtbl[];
static struct PINT_tran_tbl_s ST_write_keyval_to_dirdata_handle_trtbl[];

static PINT_sm_action mgmt_create_root_dir_mkdir_lost_and_found_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_mkdir_lost_and_found_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_mkdir_lost_and_found_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_lost_and_found_setup_msgpair_trtbl[];
static struct PINT_state_s ST_mkdir_lost_and_found_msg_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_mkdir_lost_and_found_msg_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_mkdir_lost_and_found_msg_xfer_msgpair_trtbl[];

static PINT_sm_action mgmt_create_root_dir_crdirent_lost_and_found_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_crdirent_lost_and_found_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_crdirent_lost_and_found_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_crdirent_lost_and_found_setup_msgpair_trtbl[];
static struct PINT_state_s ST_crdirent_lost_and_found_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_crdirent_lost_and_found_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_crdirent_lost_and_found_xfer_msgpair_trtbl[];

static PINT_sm_action mgmt_create_root_dir_delete_lost_and_found_handle_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_delete_lost_and_found_handle_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_delete_lost_and_found_handle_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_delete_lost_and_found_handle_setup_msgpair_trtbl[];
static struct PINT_state_s ST_delete_lost_and_found_handle_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_delete_lost_and_found_handle_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_delete_lost_and_found_handle_xfer_msgpair_trtbl[];

static PINT_sm_action mgmt_create_root_dir_cleanup_noreq(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_cleanup_noreq;
static struct PINT_pjmp_tbl_s ST_cleanup_noreq_pjtbl[];
static struct PINT_tran_tbl_s ST_cleanup_noreq_trtbl[];

struct PINT_state_machine_s pvfs2_mgmt_create_root_dir_sm = {
	.name = "pvfs2_mgmt_create_root_dir_sm",
	.first_state = &ST_check_for_request
};

static struct PINT_state_s ST_check_for_request = {
	 .state_name = "check_for_request" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_check_for_request ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_for_request_trtbl 
};

static struct PINT_tran_tbl_s ST_check_for_request_trtbl[] = {
	{ .return_value = NO_REQ ,
	 .next_state = &ST_create_dist_dir_struct },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_create_dist_dir_struct = {
	 .state_name = "create_dist_dir_struct" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_create_dist_dir_struct ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_dist_dir_struct_trtbl 
};

static struct PINT_tran_tbl_s ST_create_dist_dir_struct_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_request_remote_dirdata_dspace },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_request_remote_dirdata_dspace = {
	 .state_name = "request_remote_dirdata_dspace" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_request_remote_dirdata_dspace ,
	 .pjtbl = NULL ,
	 .trtbl = ST_request_remote_dirdata_dspace_trtbl 
};

static struct PINT_tran_tbl_s ST_request_remote_dirdata_dspace_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_create_local_dirdata_dspace },
	{ .return_value = -1 ,
	 .next_state = &ST_retry_remote_dirdata_dspace }
};

static struct PINT_state_s ST_retry_remote_dirdata_dspace = {
	 .state_name = "retry_remote_dirdata_dspace" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_retry_remote_dirdata_dspace ,
	 .pjtbl = NULL ,
	 .trtbl = ST_retry_remote_dirdata_dspace_trtbl 
};
...
static struct PINT_state_s ST_create_local_dirdata_dspace = {
	 .state_name = "create_local_dirdata_dspace" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_create_local_dirdata_dspace ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_local_dirdata_dspace_trtbl 
};

static struct PINT_tran_tbl_s ST_create_local_dirdata_dspace_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_fill_handles_to_dist_dir_struct },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_fill_handles_to_dist_dir_struct = {
	 .state_name = "fill_handles_to_dist_dir_struct" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_fill_handles_to_dist_dir_struct ,
	 .pjtbl = NULL ,
	 .trtbl = ST_fill_handles_to_dist_dir_struct_trtbl 
};

static struct PINT_tran_tbl_s ST_fill_handles_to_dist_dir_struct_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_remote_dirdata_attr_and_keyval_setup_msgpair }
};

static struct PINT_state_s ST_remote_dirdata_attr_and_keyval_setup_msgpair = {
	 .state_name = "remote_dirdata_attr_and_keyval_setup_msgpair" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_remote_dirdata_attr_and_keyval_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remote_dirdata_attr_and_keyval_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_remote_dirdata_attr_and_keyval_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_remote_dirdata_attr_and_keyval_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_remote_dirdata_attr_and_keyval_xfer_msgpair = {
	 .state_name = "remote_dirdata_attr_and_keyval_xfer_msgpair" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_remote_dirdata_attr_and_keyval_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_remote_dirdata_attr_and_keyval_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_write_keyval_to_meta_handle },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_write_keyval_to_meta_handle = {
	 .state_name = "write_keyval_to_meta_handle" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_write_keyval_to_meta_handle ,
	 .pjtbl = NULL ,
	 .trtbl = ST_write_keyval_to_meta_handle_trtbl 
};

static struct PINT_tran_tbl_s ST_write_keyval_to_meta_handle_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_write_keyval_to_dirdata_handle },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_write_keyval_to_dirdata_handle = {
	 .state_name = "write_keyval_to_dirdata_handle" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_write_keyval_to_dirdata_handle ,
	 .pjtbl = NULL ,
	 .trtbl = ST_write_keyval_to_dirdata_handle_trtbl 
};

static struct PINT_tran_tbl_s ST_write_keyval_to_dirdata_handle_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_mkdir_lost_and_found_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_mkdir_lost_and_found_setup_msgpair = {
	 .state_name = "mkdir_lost_and_found_setup_msgpair" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_mkdir_lost_and_found_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_lost_and_found_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_mkdir_lost_and_found_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_mkdir_lost_and_found_msg_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_mkdir_lost_and_found_msg_xfer_msgpair = {
	 .state_name = "mkdir_lost_and_found_msg_xfer_msgpair" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_mkdir_lost_and_found_msg_xfer_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_mkdir_lost_and_found_msg_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_crdirent_lost_and_found_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_crdirent_lost_and_found_setup_msgpair = {
	 .state_name = "crdirent_lost_and_found_setup_msgpair" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_crdirent_lost_and_found_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_crdirent_lost_and_found_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_crdirent_lost_and_found_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_crdirent_lost_and_found_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_crdirent_lost_and_found_xfer_msgpair = {
	 .state_name = "crdirent_lost_and_found_xfer_msgpair" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_crdirent_lost_and_found_xfer_msgpair_trtbl 
};
...
static struct PINT_tran_tbl_s ST_crdirent_lost_and_found_xfer_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_cleanup_noreq },
	{ .return_value = -1 ,
	 .next_state = &ST_delete_lost_and_found_handle_setup_msgpair }
};

static struct PINT_state_s ST_delete_lost_and_found_handle_setup_msgpair = {
	 .state_name = "delete_lost_and_found_handle_setup_msgpair" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_delete_lost_and_found_handle_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_delete_lost_and_found_handle_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_delete_lost_and_found_handle_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_delete_lost_and_found_handle_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup_noreq }
};

static struct PINT_state_s ST_delete_lost_and_found_handle_xfer_msgpair = {
	 .state_name = "delete_lost_and_found_handle_xfer_msgpair" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_delete_lost_and_found_handle_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_cleanup_noreq = {
	 .state_name = "cleanup_noreq" ,
	 .parent_machine = &pvfs2_mgmt_create_root_dir_sm ,
	 .flag = SM_RUN ,
	 .action.func = mgmt_create_root_dir_cleanup_noreq ,
	 .pjtbl = NULL ,
	 .trtbl = ST_cleanup_noreq_trtbl 
};
...
#ifndef WIN32
# 178 "src/server/mgmt-create-root-dir.sm"
#endif
